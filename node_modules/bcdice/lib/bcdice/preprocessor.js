...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $defs = Opal.defs, $def = Opal.def, $send = Opal.send, $truthy = Opal.truthy, $eqeq = Opal.eqeq, $thrower = Opal.thrower, self = Opal.top, $nesting = [], nil = Opal.nil;
  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $super, $parent_nesting) {
      ...
      $proto.game_system = $proto.text = nil;
      
      $defs(self, '$process', function $$process(text, game_system) {
        
        return $$('Preprocessor').$new(text, game_system).$process()
      });
      
      $def(self, '$initialize', function $$initialize(text, game_system) {
        var self = this;

        
        self.text = text;
        return (self.game_system = game_system);
      });
      ...
      $def(self, '$process', function $$process() {
        ...
        self.$trim_after_whitespace();
        self.$replace_parentheses();
        self.text = self.game_system.$change_text(self.text);
        self.$replace_implicit_d();
        return self.text;
      });
      self.$private();
      
      $def(self, '$trim_after_whitespace', function $$trim_after_whitespace() {
        var self = this;

        return (self.text = self.text.$strip().$split(/\s/, 2).$first())
      });
      
      $def(self, '$replace_parentheses', function $$replace_parentheses() {try { var $t_eval_return = $thrower('eval_return'); 
        var self = this;

        return (function(){try { var $t_break = $thrower('break'); return $send(self, 'loop', [], function $$1(){var self = $$1.$$s == null ? this : $$1.$$s, prev = nil;
          if (self.text == null) self.text = nil;

          
          prev = self.text;
          self.text = $send(self.text, 'gsub', [/\([\d\/+*\-CURF]+\)/], function $$2(expr){var self = $$2.$$s == null ? this : $$2.$$s, $ret_or_1 = nil;
            if (self.game_system == null) self.game_system = nil;

            
            if (expr == null) expr = nil;
            if ($truthy(($ret_or_1 = $$('Arithmetic').$eval(expr, self.game_system.$round_type())))) {
              return $ret_or_1
            } else {
              return expr
            };}, {$$s: self});
          if ($eqeq(prev, self.text)) {
            $t_break.$throw()
          } else {
            return nil
          };}, {$$s: self})} catch($e) {
      ...
      return $def(self, '$replace_implicit_d', function $$replace_implicit_d() {
        var self = this;

        return (self.text = $send(self.text, 'gsub', [/(\d+)D([^\w]|$)/i], function $$3(){var self = $$3.$$s == null ? this : $$3.$$s, times = nil, sides = nil, trailer = nil;
          if (self.game_system == null) self.game_system = nil;

          
          times = $$('Regexp').$last_match(1);
          sides = self.game_system.$sides_implicit_d();
          trailer = $$('Regexp').$last_match(2);
          return "" + (times) + "D" + (sides) + (trailer);}, {$$s: self}))
      });
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
});
