...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $send2 = Opal.send2, $find_super = Opal.find_super, $def = Opal.def, $eqeqeq = Opal.eqeqeq, $truthy = Opal.truthy, $rb_lt = Opal.rb_lt, $rb_gt = Opal.rb_gt, $send = Opal.send, $rb_le = Opal.rb_le, $rb_times = Opal.rb_times, $rb_plus = Opal.rb_plus, $rb_divide = Opal.rb_divide, $rb_minus = Opal.rb_minus, $nesting = [], nil = Opal.nil;
  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $const_set($nesting[0], 'ID', "Strave");
        $const_set($nesting[0], 'NAME', "碧空のストレイヴ");
        $const_set($nesting[0], 'SORT_KEY', "へきくうのすとれいふ");
        $const_set($nesting[0], 'HELP_MESSAGE', "・モラトリアムフェイズ用判定：MPm\n" + "・命中判定：nSTm*p\n" + "\n" + "「n」でダイス数を指定。\n" + "「m」で目標値を指定。省略は出来ません。\n" + "「p」で攻撃力を指定。「*」は「x」でも可。\n" + "\n" + "【書式例】\n" + "・MP6 → 目標値6のモラトリアムフェイズ用判定。\n" + "・5ST6*10 → 5d10で目標値6、攻撃力10の命中判定。\n" + "\n" + "【各種表】\n" + "・所属表：AFF　　VN版：AFV\n" + "・アイデンティティ表：IDT　　VN版：IDV\n" + "\n" + "※アイデンティティ表はエラッタ適用済です。\n");
        ...
        $def(self, '$eval_game_system_specific_command', function $$eval_game_system_specific_command(command) {
          var self = this, output = nil, $ret_or_1 = nil, diceCount = nil, target = nil, damage = nil, $ret_or_2 = nil;

          
          output = ($eqeqeq(/MP(\d+)$/i, ($ret_or_1 = command.$upcase())) ? (((diceCount = 2), (target = $$('Regexp').$last_match(1).$to_i()), self.$checkRoll(diceCount, target, nil))) : ($eqeqeq(/(\d+)ST(\d+)(x|\*)(\d+)$/i, $ret_or_1) ? (((diceCount = $$('Regexp').$last_match(1).$to_i()), (target = $$('Regexp').$last_match(2).$to_i()), (damage = ($truthy(($ret_or_2 = $$('Regexp').$last_match(4))) ? ($ret_or_2) : (0)).$to_i()), self.$checkRoll(diceCount, target, damage))) : ($eqeqeq("AFF", $ret_or_1) ? (self.$get_affiliation_table()) : ($eqeqeq("IDT", $ret_or_1) ? (self.$get_identity_table()) : ($eqeqeq("AFV", $ret_or_1) ? (self.$get_affiliation_table2()) : ($eqeqeq("IDV", $ret_or_1) ? (self.$get_identity_table2()) : (nil)))))));
          return output;
        });
        
        $def(self, '$checkRoll', function $$checkRoll(diceCount, target, damage) {
          var self = this, diceArray = nil, diceText = nil, successCount = nil, isDamage = nil, totalDamage = nil, result = nil;
          ...
          successCount = $send(diceArray, 'find_all', [], function $$1(i){
            
            if (i == null) i = nil;
            return $rb_le(i, target);}).$size();
          isDamage = damage['$nil?']()['$!']();
          if ($truthy(isDamage)) {
        ...
        $def(self, '$get_affiliation_table', function $$get_affiliation_table() {
        ...
        $def(self, '$get_identity_table', function $$get_identity_table() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$get_affiliation_table2', function $$get_affiliation_table2() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$get_identity_table2', function $$get_identity_table2() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$get_strave_1d100_table_result', function $$get_strave_1d100_table_result(name, table) {
        ...
        return $def(self, '$get_strave_table_result', function $$get_strave_table_result(name, dice, result) {
