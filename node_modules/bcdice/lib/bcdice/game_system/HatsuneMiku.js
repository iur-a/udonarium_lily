...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $send2 = Opal.send2, $find_super = Opal.find_super, $def = Opal.def, $truthy = Opal.truthy, $eqeq = Opal.eqeq, $hash2 = Opal.hash2, $rb_le = Opal.rb_le, $rb_plus = Opal.rb_plus, $send = Opal.send, $rb_minus = Opal.rb_minus, $thrower = Opal.thrower, $rb_ge = Opal.rb_ge, $hash = Opal.hash, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $const_set($nesting[0], 'ID', "HatsuneMiku");
        $const_set($nesting[0], 'NAME', "初音ミクTRPG ココロダンジョン");
        $const_set($nesting[0], 'SORT_KEY', "はつねみくTRPGこころたんしよん");
        ...
        $def(self, '$judgeRoll', function $$judgeRoll(command) {try { var $t_eval_return = $thrower('eval_return'); 
          var self = this, skillRank = nil, modifyText = nil, signOfInequality = nil, targetText = nil, specialNum = nil, $ret_or_1 = nil, specialText = nil, commandText = nil, rankDiceList = nil, diceCount = nil, modify = nil, target = nil, diceList = nil, diceText = nil, message = nil, dice = nil, total = nil, result = nil, texts = nil;
          ...
          signOfInequality = ($truthy($$('Regexp').$last_match(7)['$nil?']()) ? (">=") : ($$('Regexp').$last_match(7)));
          targetText = ($truthy($$('Regexp').$last_match(9)['$nil?']()) ? ("4") : ($$('Regexp').$last_match(9)));
          specialNum = $$('Regexp').$last_match(5);
          specialNum = ($truthy(($ret_or_1 = specialNum)) ? ($ret_or_1) : ($$('Regexp').$last_match(11)));
          specialNum = ($truthy(($ret_or_1 = specialNum)) ? ($ret_or_1) : (6));
          specialNum = specialNum.$to_i();
          specialText = ($eqeq(specialNum, 6) ? ("") : ("@" + (specialNum)));
          ...
          if ($truthy($rb_le(diceList.$length(), 1))) {
            ...
            texts = [];
            $send(diceList, 'each_with_index', [], function $$1(pickup_dice, index){var self = $$1.$$s == null ? this : $$1.$$s, rests = nil, colorList = nil, color = nil;

              
              if (pickup_dice == null) pickup_dice = nil;
              ...
              return texts['$<<']("　ネイロに" + (pickup_dice) + "(" + (color) + ")を取得した場合 " + (total) + ":" + (result));}, {$$s: self});
            texts['$uniq!']();
        ...
        $def(self, '$getChangedModifyText', function $$getChangedModifyText(text) {
          var modifyText = nil, values = nil;

          
          modifyText = "";
          values = text.$split(/,/);
          $send(values, 'each', [], function $$2(value){
            
            if (value == null) value = nil;
            
            switch (value.valueOf()) {
              case "++":
                return (modifyText = $rb_plus(modifyText, "+2"))
              case "+":
                return (modifyText = $rb_plus(modifyText, "+1"))
              default:
                return (modifyText = $rb_plus(modifyText, value))
            };});
          return modifyText;
        });
        
        $def(self, '$check_success', function $$check_success(total_n, dice_n, signOfInequality, diff, special_n) {
          var cmp_op = nil, target_num = nil;
