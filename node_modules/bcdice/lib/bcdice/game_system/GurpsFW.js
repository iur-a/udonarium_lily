...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $send2 = Opal.send2, $find_super = Opal.find_super, $def = Opal.def, $eqeq = Opal.eqeq, $rb_minus = Opal.rb_minus, $truthy = Opal.truthy, $rb_ge = Opal.rb_ge, $rb_le = Opal.rb_le, $eqeqeq = Opal.eqeqeq, $to_ary = Opal.to_ary, $rb_plus = Opal.rb_plus, $rb_gt = Opal.rb_gt, $rb_lt = Opal.rb_lt, $rb_divide = Opal.rb_divide, $not = Opal.not, $send = Opal.send, $thrower = Opal.thrower, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $def(self, '$result_nd6', function $$result_nd6(total, dice_total, dice_list, cmp_op, target) {
          var success = nil, crt_string = nil, fmb_string = nil, fail_string = nil;

          
          if ($eqeq(target, "?")) {
            return $$('Result').$nothing()
          };
          if (!($eqeq(dice_list.$size(), 3) && ($eqeq(cmp_op, "<=")))) {
            return nil
          };
          ...
          if (($truthy($rb_le(dice_total, 6)) && ($truthy($rb_ge(target, 16))))) {
            return crt_string
          } else if (($truthy($rb_le(dice_total, 5)) && ($truthy($rb_ge(target, 15))))) {
            return crt_string
          ...
          if ($truthy($rb_le($rb_minus(target, dice_total), -10))) {
            return fmb_string
          } else if (($truthy($rb_ge(dice_total, 17)) && ($truthy($rb_le(target, 15))))) {
            return fmb_string
        ...
        $def(self, '$eval_game_system_specific_command', function $$eval_game_system_specific_command(string) {
          var $a, $b, self = this, tableName = nil, result = nil, number = nil, $ret_or_1 = nil, table = nil, modify = nil, dice = nil, num = nil, diff = nil, dif = nil, depth = nil, dice1 = nil, dice2 = nil, area = nil, dice3 = nil, mode = nil, type = nil, text = nil;

          
          tableName = "";
          result = "";
          number = 0;
          if ($eqeqeq("CRT", ($ret_or_1 = string))) {
            ...
            $b = self.$get_table_by_nD6(table, 3), $a = $to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
          } else if ($eqeqeq("HCRT", $ret_or_1)) {
            ...
            result = table['$[]'](num);
          } else if ($eqeqeq(/REACT((\+|-)?\d*)/, $ret_or_1)) {
          ...
          } else if ($eqeqeq(/TRAP(\w)/, $ret_or_1)) {
            
            tableName = "トラップリスト";
            diff = $$('Regexp').$last_match(1);
            $b = self.$getTrapTable(diff), $a = $to_ary($b), (dif = ($a[0] == null ? nil : $a[0])), (table = ($a[1] == null ? nil : $a[1])), $b;
            if ($truthy(table['$nil?']())) {
              return ""
            };
            $b = self.$get_table_by_nD6(table, 3), $a = $to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
            result = "" + (dif) + "：" + (result);
          } else if ($eqeqeq(/TRS(E|N|H|L)(\d+)((\+|-)?\d*)/, $ret_or_1)) {
            
            tableName = "財宝テーブル";
            diff = $$('Regexp').$last_match(1);
            depth = $$('Regexp').$last_match(2).$to_i();
            num = $rb_divide(depth, 10).$to_i();
            ...
            if (!$truthy($$('Regexp').$last_match(4)['$nil?']())) {
              num = $rb_plus(num, $$('Regexp').$last_match(3).$to_i())
            };
          ...
          } else if ($eqeqeq(/RAND(E|N|H|L)(\d)?/, $ret_or_1)) {
            
            tableName = "ランダムイベント表";
            diff = $$('Regexp').$last_match(1);
            if ($not($$('Regexp').$last_match(2)['$nil?']())) {
              dice1 = $$('Regexp').$last_match(2).$to_i()
            } else {
              dice1 = self.randomizer.$roll_once(6)
            };
            dice2 = self.randomizer.$roll_once(6);
            $b = self.$getRandomEvent(dice1, dice2, diff), $a = $to_ary($b), (area = ($a[0] == null ? nil : $a[0])), (dif = ($a[1] == null ? nil : $a[1])), (table = ($a[2] == null ? nil : $a[2])), $b;
            $b = self.$get_table_by_1d6(table), $a = $to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (dice3 = ($a[1] == null ? nil : $a[1])), $b;
            number = "" + (dice1) + (dice2) + (dice3);
            result = "" + (area) + "(" + (dif) + ")：" + (result);
          } else if ($eqeqeq(/RENC(E|N|H|L)(\d)?/, $ret_or_1)) {
            ...
            $b = self.$get_table_by_1d6(table), $a = $to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
          } else if ($eqeqeq(/DROP(N)?((\+)?(\d))?/, $ret_or_1)) {
            ...
            if ($truthy($rb_le(number, 3))) {
              result = "レアアイテム1"
            } else if (($truthy($rb_le(number, 4)) && ($eqeq(mode, "N")))) {
              result = "レアアイテム2"
            } else if ($truthy($rb_lt(number, 7))) {
              if ($eqeq(mode, "N")) {
                result = "CL×200GP"
            ...
            $b = self.$get_table_by_nD6(table, 3), $a = $to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
          } else if ($eqeqeq("RANDOP", $ret_or_1)) {
          ...
          } else if ($eqeqeq(/LOT(N|P)/, $ret_or_1)) {
        ...
        $def(self, '$normal1', function $$normal1() {try { var $t_return = $thrower('return'); 
          var $a, $b, self = this, table = nil, result = nil;

          
          table = ["イレブンチキン", "イレブンチキン", "イレブンチキン", $send(self, 'lambda', [], function $$1(){var self = $$1.$$s == null ? this : $$1.$$s;

            $t_return.$throw(self.$normal2().$to_s())}, {$$s: self, $$ret: $t_return}), $send(self, 'lambda', [], function $$2(){var self = $$2.$$s == null ? this : $$2.$$s;

            $t_return.$throw(self.$normal2().$to_s())}, {$$s: self, $$ret: $t_return}), $send(self, 'lambda', [], function $$3(){var self = $$3.$$s == null ? this : $$3.$$s;

            $t_return.$throw(self.$normal3().$to_s())}, {$$s: self, $$ret: $t_return})];
          $b = self.$get_table_by_1d6(table), $a = $to_ary($b), (result = ($a[0] == null ? nil : $a[0])), $b;
        ...
        $def(self, '$normal2', function $$normal2() {try { var $t_return = $thrower('return'); 
          var $a, $b, self = this, table = nil, result = nil;

          
          table = ["バロールたわし", "イグニスジッポ", "ヤコ仮面or梟の文鎮(選択可)", "ナレッジのハンモックorジンジャビースト", $send(self, 'lambda', [], function $$4(){var self = $$4.$$s == null ? this : $$4.$$s;

            $t_return.$throw(self.$normal3().$to_s())}, {$$s: self, $$ret: $t_return}), $send(self, 'lambda', [], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s;
        ...
        $def(self, '$normal3', function $$normal3() {try { var $t_return = $thrower('return'); 
          var $a, $b, self = this, table = nil, result = nil;

          
          table = ["特性HPポーション", "特性MPポーション", "黒い甲冑", "天体望遠鏡", "金獅子の剥製", $send(self, 'lambda', [], function $$6(){var self = $$6.$$s == null ? this : $$6.$$s;

            $t_return.$throw(self.$normal4().$to_s())}, {$$s: self, $$ret: $t_return})];
          $b = self.$get_table_by_1d6(table), $a = $to_ary($b), (result = ($a[0] == null ? nil : $a[0])), $b;
          return result;} catch($e) {
            if ($e === $t_return) return $e.$v;
            throw $e;
        ...
        $def(self, '$normal4', function $$normal4() {try { var $t_return = $thrower('return'); 
          var $a, $b, self = this, table = nil, result = nil;

          
          table = ["特性スタミナポーション", "戦乙女の兜", "フェンリルの首輪", "フェニックスカーペット", "動くアダマンゴーレム", $send(self, 'lambda', [], function $$7(){var self = $$7.$$s == null ? this : $$7.$$s;

            $t_return.$throw(self.$normal5().$to_s())}, {$$s: self, $$ret: $t_return})];
          $b = self.$get_table_by_1d6(table), $a = $to_ary($b), (result = ($a[0] == null ? nil : $a[0])), $b;
          return result;} catch($e) {
            if ($e === $t_return) return $e.$v;
            throw $e;
        ...
        $def(self, '$normal5', function $$normal5() {try { var $t_return = $thrower('return'); 
          var $a, $b, self = this, table = nil, result = nil;

          
          table = ["キャンディークッション", "屑鉄の金床", "薪割り王の斧", "ロジエの水差し", "箱舟の模型", $send(self, 'lambda', [], function $$8(){var self = $$8.$$s == null ? this : $$8.$$s;

            $t_return.$throw(self.$premium5().$to_s())}, {$$s: self, $$ret: $t_return})];
          $b = self.$get_table_by_1d6(table), $a = $to_ary($b), (result = ($a[0] == null ? nil : $a[0])), $b;
          return result;} catch($e) {
            if ($e === $t_return) return $e.$v;
            throw $e;
        ...
        $def(self, '$premium1', function $$premium1() {try { var $t_return = $thrower('return'); 
          var $a, $b, self = this, table = nil, result = nil;

          
          table = ["プレミアムチキン", "プレミアムチキン", "プレミアムチキン", $send(self, 'lambda', [], function $$9(){var self = $$9.$$s == null ? this : $$9.$$s;

            $t_return.$throw(self.$normal3().$to_s())}, {$$s: self, $$ret: $t_return}), $send(self, 'lambda', [], function $$10(){var self = $$10.$$s == null ? this : $$10.$$s;

            $t_return.$throw(self.$premium2().$to_s())}, {$$s: self, $$ret: $t_return}), $send(self, 'lambda', [], function $$11(){var self = $$11.$$s == null ? this : $$11.$$s;

            $t_return.$throw(self.$premium2().$to_s())}, {$$s: self, $$ret: $t_return})];
          $b = self.$get_table_by_1d6(table), $a = $to_ary($b), (result = ($a[0] == null ? nil : $a[0])), $b;
          return result;} catch($e) {
            if ($e === $t_return) return $e.$v;
            throw $e;
        ...
        $def(self, '$premium2', function $$premium2() {try { var $t_return = $thrower('return'); 
          var $a, $b, self = this, table = nil, result = nil;

          
          table = ["親衛隊バッジ", "ハタモトチャブダイ", "星のコンパス", "白銀の甲冑", $send(self, 'lambda', [], function $$12(){var self = $$12.$$s == null ? this : $$12.$$s;

            $t_return.$throw(self.$normal4().$to_s())}, {$$s: self, $$ret: $t_return}), $send(self, 'lambda', [], function $$13(){var self = $$13.$$s == null ? this : $$13.$$s;

            $t_return.$throw(self.$premium3().$to_s())}, {$$s: self, $$ret: $t_return})];
          $b = self.$get_table_by_1d6(table), $a = $to_ary($b), (result = ($a[0] == null ? nil : $a[0])), $b;
          return result;} catch($e) {
            if ($e === $t_return) return $e.$v;
            throw $e;
        ...
        $def(self, '$premium3', function $$premium3() {try { var $t_return = $thrower('return'); 
          var $a, $b, self = this, table = nil, result = nil;

          
          table = ["特性クイックHPポーション", "特性クイックMPポーション", "特製クイックスタミナポーション", "火龍のフィギュアor氷龍のフィギュア(選択可)", "ヒメショーグンドレス", $send(self, 'lambda', [], function $$14(){var self = $$14.$$s == null ? this : $$14.$$s;

            $t_return.$throw(self.$premium4().$to_s())}, {$$s: self, $$ret: $t_return})];
          $b = self.$get_table_by_1d6(table), $a = $to_ary($b), (result = ($a[0] == null ? nil : $a[0])), $b;
          return result;} catch($e) {
            if ($e === $t_return) return $e.$v;
            throw $e;
        ...
        $def(self, '$premium4', function $$premium4() {try { var $t_return = $thrower('return'); 
          var $a, $b, self = this, table = nil, result = nil;

          
          table = ["クイックユグドラポーション", "銀河龍のフィギュア/ドラゴン", "銀河龍のフィギュア/魔族", "魔族チェスセット", "イグニスコンロ", $send(self, 'lambda', [], function $$15(){var self = $$15.$$s == null ? this : $$15.$$s;
        ...
        $def(self, '$premium5', function $$premium5() {try { var $t_return = $thrower('return'); 
          var $a, $b, self = this, table = nil, result = nil;

          
          table = ["グレヴディバリウス", "天使の望遠鏡orデスの目覚まし時計(選択可)", "世界樹の蔦", "死神の飾りドレス", "ザバーニヤ等身大フィギュア", $send(self, 'lambda', [], function $$16(){var self = $$16.$$s == null ? this : $$16.$$s;

            $t_return.$throw(self.$premium6().$to_s())}, {$$s: self, $$ret: $t_return})];
          $b = self.$get_table_by_1d6(table), $a = $to_ary($b), (result = ($a[0] == null ? nil : $a[0])), $b;
          return result;} catch($e) {
            if ($e === $t_return) return $e.$v;
            throw $e;
        ...
        $def(self, '$premium6', function $$premium6() {
          var $a, $b, self = this, table = nil, result = nil;
        ...
        $def(self, '$getLotResult', function $$getLotResult(type) {
          var self = this;
        ...
        $def(self, '$getTresureTable', function $$getTresureTable(num) {
          var table = nil;
          ...
          switch (num.valueOf()) {
            case -1:
              table = ["HPポーション(消耗品)", "MPポーション(消耗品)", "スタミナポーション(消耗品)", "抵抗ポーション(消耗品)", "マジックパウダー：無(消耗品)", "200GP"]
              break;
            case 0:
              table = ["高級HPポーション(消耗品)", "高級MPポーション(消耗品)", "高級スタミナポーション(消耗品)", "高級抵抗ポーション(消耗品)", "マジックパウダー：銀(消耗品)", "600GP"]
              break;
            case 1:
              table = ["大地の守り(装飾品)", "ファインウェポンケース(装飾品)", "狩人の羽帽子(装飾品)", "狙撃手の指貫(装飾品)", "スタミナバンド・健康お守り・レザーマント3点セット(装飾品)", "1200GP"]
              break;
            case 2:
              table = ["ミスリルダガーorミスリルシールドを選択(短剣or盾)", "高級クイック能力増加ポーション(消耗品)", "高級クイックHPポーション(消耗品)", "高級クイックMPポーション(消耗品)", "装飾品1つ(3000GPまでのもの)", "2000GP"]
              break;
            case 3:
              table = ["ミスリル武器(4000GPまでのもの)", "最高級能力増加ポーション(消耗品)", "高級クイック再生ポーション(消耗品)", "魔法1つ(5000GPまでのもの)", "防具1つ(5000GPまでのもの)", "3000GP"]
              break;
            case 4:
              table = ["オサフネorサスケブレードを選択(刀)", "アダマンダガー", "弓1つ(5000GPまでのもの)", "ギロチンブレード(両手剣)", "装飾品1つ(5000GPまでのもの)", "4500GP"]
              break;
            case 5:
              table = ["アダマン武器(8000GPまでのもの)", "アダマンシールド(盾)", "ミスリルスケイル", "蘇生ポーション", "装飾品1つ(10000GPまでのもの)", "6000GP"]
              break;
            case 6:
              table = ["武器1つ(612000GPまでのもの)", "盾1つ(12000GPまでのもの)", "鎧1つ(12000GPまでのもの)", "蘇生ポーション", "装飾品1つ(15000GPまでのもの)", "10000GP"]
              break;
            case 7:
              table = ["武器1つ(30000GPまでのもの)", "盾1つ(30000GPまでのもの)", "鎧1つ(30000GPまでのもの)", "蘇生ポーション+特製クイックHPポーション(特製は人数分)", "装飾品1つ(40000GPまでのもの)", "25000GP"]
              break;
            case 8:
              table = ["武器1つ(60000GPまでのもの)", "盾1つ(60000GPまでのもの)", "鎧1つ(60000GPまでのもの)", "蘇生ポーション+特製クイックポーション(特製は人数分、ＨＰ・ＭＰ・スタミナの３種)", "装飾品1つ(80000GPまでのもの)", "50000GP"]
              break;
            case 9:
              table = ["武器1つ(150000GPまでのもの)", "盾1つ(150000GPまでのもの)", "鎧1つ(150000GPまでのもの)", "クイック蘇生ポーション+特製クイックポーション(特製は人数分、ＨＰ・ＭＰ・スタミナの３種)", "装飾品1つ(200000GPまでのもの)", "黄金の守護者の証(装飾品)+黄金の電子暗号キー(装飾品)"]
              break;
            default:
              table = nil
          };
        ...
        $def(self, '$getTrapTable', function $$getTrapTable(diff) {
          var dif = nil, d = nil, table = nil;
        ...
        $def(self, '$getRandomEvent', function $$getRandomEvent(dice1, dice2, diff) {
          var self = this, dif = nil, d = nil, area = nil, table = nil;
          ...
          switch (dice1.valueOf()) {
            case 1:
              
              area = "洞窟";
              
              switch (dice2.valueOf()) {
                case 1:
                  table = ["回復の泉。PC全員のHP・MP・FPが完全に回復する。気絶・朦朧状態も回復。", "淡い光を放つ鉱石に包まれた部屋に出る。フォーチュンが" + (self.$getRandomDiff(dice1, 12, d, 0)) + "点回復する。", "天井が開いていて植物の育っている洞窟内庭園。" + (self.$getRandomDiff(dice1, 13, d, 0)) + "に成功すると力の沸く木の実を見つけHP・FP・MPを" + (self.$getRandomDiff(dice1, 13, d, 1)) + "点回復できる。", "洞窟内で栽培できる特殊なキノコを栽培するフラウに出会う。100GP支払うことでキノコを1つ譲ってもらうことができ、シナリオ終了まで《怪力2》《すばやさ2》《知恵2》《活力2》のいずれかの効果を得る(ランダム)このキノコは持ち帰ることはできず、2つめを食べても効果はない。", "ギア技術を用いた強力な懐中電灯のおいてある休憩室。迷宮を出るまで洞窟の深度判定で「暗視」があるものとして扱う。迷宮を出ると懐中電灯は寿命が来たのか壊れてしまう。", "不思議な光を放つ水が沸いている。パーティーメンバーのHP・MP・FPのいずれかが減少している場合このイベントは拒否できない。また、全快でも「好奇心」を持つキャラクターは知力判定に失敗すると飲みにいこうとする。飲んだキャラクターは1Dを振り、以下のような効果が発生する。ロールプレイが面白かった場合シナリオ終了時に1CPのボーナスを与えてもよい。\n" + "----------\n" + "1：HP・MP・FP全回復\n" + "2：シナリオ終了まで肉体的に不利な特徴が1つ消滅する\n" + "3：シナリオ終了まで精神的に不利な特徴が1つ消滅する\n" + "4：HP・MP・FPが現在地の半分になる　HPがマイナスの場合はHP・MP・FP全回復\n" + "5：シナリオ終了まで余分な獣っぽい耳や尻尾が生える　聴覚判定+4\n" + "6：シナリオ終了まで性別が男女入れ替わる。\n" + "----------"]
                  break;
                case 2:
                  table = ["財宝(カギ・トラップなし)。財宝の中身は1段階低い深度の財宝テーブルを使用する。", "財宝(カギつき。行動を消費して" + (self.$getRandomDiff(dice1, 22, d, 0)) + "に成功すれば開く)財宝の中身は1段階低い深度の財宝テーブルを使用する。", "財宝(カギなし、トラップつき。行動を消費して" + (self.$getRandomDiff(dice1, 23, d, 0)) + "に成功すれば解除可能)財宝の中身は1段階低い深度の財宝テーブルを使用する。", "財宝(カギ、トラップつき。行動を消費して" + (self.$getRandomDiff(dice1, 24, d, 0)) + "に成功すれば解除可能)財宝の中身は1段階低い深度の財宝テーブルを使用する。", "ミミックの罠。ランダムなキャラクターに3Dの「切り」ダメージを与える。" + (self.$getRandomDiff(dice1, 25, d, 0)) + "に成功すればこの罠を見抜いて無効化することができ、なおかつ「深度×" + (self.$getRandomDiff(dice1, 25, d, 1)) + "」GPを入手可能。", "トレジャーイーターの罠。冒険中に入手したアイテム(消耗品・GP以外)を全て失う。" + (self.$getRandomDiff(dice1, 26, d, 0)) + "に成功すればこの罠を見抜いて無効化することができる。"]
                  break;
                case 3:
                  table = ["洞窟内で近道を発見。深度が1D+1増加する。", "洞窟内で近道を発見。深度が1D増加する。細い道のため、体の大きなキャラクター(STが13以上)は、通るのに苦労してFPを1点消耗する", "分かれ道。2分の1の確率で深度が1D増加する。「方向感覚」があれば必ず増加。", "足場の悪い近道。PTの誰かが" + (self.$getRandomDiff(dice1, 34, d, 0)) + "に成功すれば深度が1D増加する。失敗した場合は" + (self.$getRandomDiff(dice1, 34, d, 1)) + "の「叩き」ダメージを受ける", "大きな岩でふさがれた近道。1ラウンドで破壊することができれば深度が1D増加する。岩はどのヘクスからでも攻撃可能。分類：岩石、防護点8、" + (self.$getRandomDiff(dice1, 35, d, 0)) + "、切り刺しダメージボーナス無効。", "道が3つに分かれている。1Dで1、2が出るとペナルティなし、1Dで3、4が出ると深度-2、1Dで5、6が出ると深度-4。「直感」があれば、" + (self.$getRandomDiff(dice1, 36, d, 0)) + "の判定に成功すれば正しい道を選択可能。"]
                  break;
                case 4:
                  table = ["" + (self.$getRandomDiff(dice1, 41, d, 0)) + "とエンカウント。2ラウンド経過するとキャンディークラウンは戦場全域に《べたべた》をかけて逃亡する。", "" + (self.$getRandomDiff(dice1, 42, d, 0)) + "彼らはお互いに争っているがPCたちを見つけると向きを変えて襲い掛かってくる。" + (self.$getRandomDiff(dice1, 42, d, 1)), "" + (self.$getRandomDiff(dice1, 43, d, 0)) + "相手は洞窟では巧妙に擬態しており、【ハイドインシャドウ】状態とみなす。" + (self.$getRandomDiff(dice1, 43, d, 1)), "" + (self.$getRandomDiff(dice1, 44, d, 0)) + "トロッコに乗って逃げつつの戦闘になり、2ラウンド以内に倒せなければ轢かれてPC全員が" + (self.$getRandomDiff(dice1, 44, d, 1)) + "の防護点無視ダメージを受ける。また、1ラウンドに1人誰かが体力判定を行ってトロッコを運転する必要があり、これに失敗すると即座に轢かれてしまう。轢かれると戦闘は終了する。パーテイー内にケイヴウォーカーがいればこの判定は不要。", "炎の燃え盛る洞窟。深度判定直前に炎で" + (self.$getRandomDiff(dice1, 45, d, 0)) + "の「叩き」ダメージを受ける。さらに" + (self.$getRandomDiff(dice1, 45, d, 1)) + "とエンカウント。火炎弱点のモンスターがいれば即座に逃亡する。", "冷気に包まれた洞窟。深度判定直前に冷気で" + (self.$getRandomDiff(dice1, 46, d, 0)) + "のFPダメージを受ける(防護点無視)さらに" + (self.$getRandomDiff(dice1, 46, d, 1)) + "とエンカウント。冷気弱点のモンスターがいれば即座に逃亡する。"]
                  break;
                case 5:
                  table = ["落盤がモンスターを押しつぶす。戦闘中の場合ランダムなモンスター1人を即死させる。APやドロップ品も入手可能。それ以外の場合は特に何も起きない。", "採掘用のダイナマイトが打ち捨てられている。行動ターンを消費して使用することで任意の半径" + (self.$getRandomDiff(dice1, 52, d, 0)) + "の敵味方全員に" + (self.$getRandomDiff(dice1, 52, d, 1)) + "の「叩き」ダメージを与える。命中判定は自動的に0成功とし、《爆裂火球》と同様にダメージの軽減が可能。", "有毒ガスが発生している。分類「ギア」「アンデッド」以外のキャラクターは敵味方全員" + (self.$getRandomDiff(dice1, 53, d, 0)) + "で判定を行い、失敗度分のダメージを受ける。《空気浄化》などがあれば使用することで無効化できる。", "溶岩の流れる部屋。深度判定直前に炎で" + (self.$getRandomDiff(dice1, 54, d, 0)) + "の「叩き」ダメージを受ける。深度判定を行い、失敗したキャラクターはさらに追加で" + (self.$getRandomDiff(dice1, 54, d, 0)) + "の「叩き」ダメージを受ける。", "落盤がPCのうちランダムに1人を押しつぶす。受動防御無視の" + (self.$getRandomDiff(dice1, 55, d, 0)) + "に失敗すると" + (self.$getRandomDiff(dice1, 55, d, 1)) + "の「叩き」ダメージを受ける。パーティーの誰かが「第六感」か「視覚-5」の判定に成功すれば事前に回避可能。(「暗視」があれば「視覚-2」でも判定可能)", "進んできた道の後方が急に崩落する。ダンジョン攻略が完了するまで「撤退」ができなくなるが、「深度」が現時点より下がることがなくなる。"]
                  break;
                case 6:
                  table = ["プラネタリウムのように鉱石が輝く部屋。星の配置に関する謎かけになっている。行動を消費して" + (self.$getRandomDiff(dice1, 61, d, 0)) + "に成功すればこの謎を解くことができる。謎が解けると" + (self.$getRandomDiff(dice1, 61, d, 1)) + "が入手できる。", "地熱で温泉が湧いている。このイベントが発生するとモンスターは消滅する。みんなで温泉に浸かることでFPが全回復する。また、温泉の薬効により受けていた毒は無効化され、ラウンドの最初にHPが" + (self.$getRandomDiff(dice1, 62, d, 0)) + "点ずつ回復するようになる。", "地下渓流を発見する。深度判定が体力判定ではなく<水泳>判定になる。深度判定に" + (self.$getRandomDiff(dice1, 63, d, 0)) + "成功以上した場合は地底湖に沈む財宝を発見可能。財宝にカギやトラップはなく、中身は深度そのままの財宝テーブルを使用する。", "アダマン鉱脈を発見する。「<採掘>の成功度×深度×" + (self.$getRandomDiff(dice1, 64, d, 0)) + "」GP分のアダマン鉱石を入手可能。複数人数で判定を行えばその回数分入手可能。ただし50GP分ごとに重量が1kg。撤退・全滅した場合アダマン鉱石は消滅する。", "強烈な磁力を放つ鉱石のある部屋。金属製の防具は重量を2倍に計算する。続いてエンカウント表(4-1～4-6)を振ること。なお、4-5の部屋の炎と4-6の部屋の冷気による効果は適用しない。", "怪しい光を放つ鉱石の部屋。鉱石は無生物を破壊する振動を放っており、武器に" + (self.$getRandomDiff(dice1, 66, d, 0)) + "の効果を与える。また、種族「ギア」のキャラクターも同様の効果を受ける。ラウンド終了前に鉱石を破壊すればこの効果は受けない。鉱石はどのヘクスからでも攻撃可能。分類：岩石、防護点8、HP" + (self.$getRandomDiff(dice1, 66, d, 1)) + "、切り刺しダメージボーナス無効。"]
                  break;
                default:
                  table = nil
              };
        ...
        return $def(self, '$getRandomDiff', function $$getRandomDiff(dice1, dice23, dif, index) {
          var self = this, table = nil, result = nil;
