  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $const_set($nesting[0], 'ID', "Peekaboo");
        $const_set($nesting[0], 'NAME', "ピーカーブー");
        $const_set($nesting[0], 'SORT_KEY', "ひいかあふう");
        ...
        $def(self, '$result_2d6', function $$result_2d6(_total, dice_total, _dice_list, cmp_op, _target) {
          ...
          if ($truthy($rb_le(dice_total, 2))) {
            return $$('Result').$fumble("ファンブル(【眠気】が1d6点上昇)")
          } else if ($truthy($rb_ge(dice_total, 12))) {
            return $$('Result').$critical("スペシャル(【魔力】あるいは【眠気】が1d6点回復)")
          } else {
            return nil
          };
        });
