...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $send2 = Opal.send2, $find_super = Opal.find_super, $def = Opal.def, $eqeq = Opal.eqeq, $truthy = Opal.truthy, $rb_ge = Opal.rb_ge, $rb_plus = Opal.rb_plus, $neqeq = Opal.neqeq, $hash2 = Opal.hash2, $send = Opal.send, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $const_set($nesting[0], 'ID', "GranCrest");
        $const_set($nesting[0], 'NAME', "グランクレストRPG");
        $const_set($nesting[0], 'SORT_KEY', "くらんくれすとRPG");
        $const_set($nesting[0], 'HELP_MESSAGE', "・2D6の目標値判定でクリティカル処理\n" + "　例）3d6>=19 3d6+5>=24\n" + "・邂逅表（MT）\n" + "・感情表（-FT）\n" + "　ポジティブ感情表（PFT）、ネガティブ感情表（NFT）\n" + "・国特徴表（-CT）\n" + "　カテゴリー表（CT）、地形表（TCT）、産業表（ICT）、人物表（PCT）\n" + "　組織表（OCT）、拠点表（BCT）、文化表（CCT）\n");
        ...
        $def(self, '$result_nd6', function $$result_nd6(total, _dice_total, dice_list, cmp_op, target) {
          var result = nil, sequence = nil;
