...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $send2 = Opal.send2, $find_super = Opal.find_super, $def = Opal.def, $truthy = Opal.truthy, $rb_plus = Opal.rb_plus, $rb_ge = Opal.rb_ge, $rb_le = Opal.rb_le, $thrower = Opal.thrower, $neqeq = Opal.neqeq, $range = Opal.range, $hash2 = Opal.hash2, self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $const_set($nesting[0], 'ID', "TwilightGunsmoke");
        $const_set($nesting[0], 'NAME', "トワイライトガンスモーク");
        $const_set($nesting[0], 'SORT_KEY', "とわいらいとかんすもおく");
        ...
        $def(self, '$check_roll', function $$check_roll(command) {try { var $t_eval_return = $thrower('eval_return'); 
          var self = this, m = nil, modify_number = nil, target = nil, critical = nil, $ret_or_1 = nil, fumble = nil, dice_list = nil, dice_value = nil, dice_str = nil, total = nil, result = nil, sequence = nil;
          ...
          modify_number = ($truthy(m['$[]'](1)) ? ($$('ArithmeticEvaluator').$eval(m['$[]'](1))) : (0));
          target = m['$[]'](2).$to_i();
          critical = ($truthy(($ret_or_1 = m['$[]'](4))) ? ($ret_or_1) : (12)).$to_i();
          fumble = ($truthy(($ret_or_1 = m['$[]'](6))) ? ($ret_or_1) : (2)).$to_i();
          dice_list = self.randomizer.$roll_barabara(2, 6).$sort();
          dice_value = dice_list.$sum();
          dice_str = dice_list.$join(",");
          total = $rb_plus(dice_value, modify_number);
          result = ($truthy($rb_ge(dice_value, critical)) ? ("自動成功") : ($truthy($rb_le(dice_value, fumble)) ? ("自動失敗") : ($truthy($rb_ge(total, target)) ? ("成功") : ("失敗"))));
          sequence = ["(" + (command) + ")", "" + (dice_value) + "[" + (dice_str) + "]" + ($$('Format').$modifier(modify_number)), total.$to_s(), result];
