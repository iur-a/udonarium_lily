...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $send2 = Opal.send2, $find_super = Opal.find_super, $def = Opal.def, $send = Opal.send, $eqeq = Opal.eqeq, $truthy = Opal.truthy, $rb_le = Opal.rb_le, $rb_ge = Opal.rb_ge, $rb_plus = Opal.rb_plus, $rb_minus = Opal.rb_minus, $rb_gt = Opal.rb_gt, $rb_lt = Opal.rb_lt, $neqeq = Opal.neqeq, $thrower = Opal.thrower, $hash2 = Opal.hash2, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $const_set($nesting[0], 'ID', "MeikyuDays");
        $const_set($nesting[0], 'NAME', "迷宮デイズ");
        $const_set($nesting[0], 'SORT_KEY', "めいきゆうていす");
        $const_set($nesting[0], 'HELP_MESSAGE', "・判定　(nMD+m)\n" + "　n個のD6を振って大きい物二つだけみて達成値を算出します。修正mも可能です。\n" + "　絶対成功と絶対失敗も自動判定します。\n" + "・各種表\n" + "　・散策表　　　　　　DRT\n" + "　・交渉表　　　　　　DNT\n" + "　・休憩表　　　　　　DBT\n" + "　・ハプニング表　　　DHT\n" + "　・カーネル停止表　　KST\n" + "　・痛打表　CAT／戦闘ファンブル表　CFT／致命傷表　FWT\n" + "　・おたから表１／２／３／４　T1T/T2T/T3T/T4T\n" + "　・相場表　　　　　　MPT\n" + "　・登場表　　　　　　APT\n" + "　・因縁表　DCT／怪物因縁表　MCT／PC因縁表　PCT／ラブ因縁表　LCT\n" + "・D66ダイスあり\n");
        ...
        $def(self, '$replace_text', function $$replace_text(string) {
          ...
          string = $send(string, 'gsub', [/(\d+)MD6/i], function $$1(){
            return "" + ($$('Regexp').$last_match(1)) + "R6"});
          string = $send(string, 'gsub', [/(\d+)MD/i], function $$2(){
            return "" + ($$('Regexp').$last_match(1)) + "R6"});
          return string;
        });
        ...
        $def(self, '$checkRoll', function $$checkRoll(string) {try { var $t_eval_return = $thrower('eval_return'); 
          var self = this, m = nil, dice_c = nil, bonus = nil, signOfInequality = nil, diff = nil, bonusText = nil, dice_num = nil, dice_str = nil, dice_now = nil, total_n = nil, output = nil, cmp_op = nil, result = nil;
          ...
          if (!$truthy(bonusText['$nil?']())) {
            bonus = $$('ArithmeticEvaluator').$eval(bonusText)
          };
          if ($truthy(m['$[]'](6))) {
          ...
          dice_num = self.randomizer.$roll_barabara(dice_c, 6).$sort();
          ...
          if ($neqeq(signOfInequality, "")) {
            ...
            result = self.$result_2d6(total_n, dice_now, dice_num, cmp_op, diff);
            if ($truthy(result)) {
              output = $rb_plus(output, " ＞ " + (result.$text()))
            };
          };
