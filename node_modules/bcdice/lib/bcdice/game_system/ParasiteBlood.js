...
Opal.modules["bcdice/game_system/DemonParasite"] = function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $send2 = Opal.send2, $find_super = Opal.find_super, $def = Opal.def, $truthy = Opal.truthy, $rb_ge = Opal.rb_ge, $eqeq = Opal.eqeq, $eqeqeq = Opal.eqeqeq, $rb_gt = Opal.rb_gt, $rb_lt = Opal.rb_lt, $rb_minus = Opal.rb_minus, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $def(self, '$result_nd6', function $$result_nd6(_total, _dice_total, dice_list, _cmp_op, target) {
          
          if ($truthy($rb_ge(dice_list.$count(1), 2))) {
            return $$('Result').$fumble("致命的失敗")
          } else if ($truthy($rb_ge(dice_list.$count(6), 2))) {
            return $$('Result').$critical("効果的成功")
          } else if ($eqeq(target, "?")) {
        ...
        $def(self, '$get_urge', function $$get_urge(string) {
          var self = this, m = nil, initialWord = nil, urgelv = nil, $ret_or_1 = nil, title = nil, urge = nil, dice_now = nil, resultText = nil;
          ...
          initialWord = m['$[]'](1);
          urgelv = m['$[]'](2).$to_i();
          if ($eqeqeq(nil, ($ret_or_1 = initialWord))) {
            
            title = "衝動表";
            urge = $$('URGE_TABLE');
          } else if ($eqeqeq("N", $ret_or_1)) {
            
            title = "新衝動表";
            urge = $$('NEW_URGE_TABLE');
          } else if ($eqeqeq("A", $ret_or_1)) {
            
            title = "誤作動表";
            urge = $$('MALFUNCTION_TABLE');
          } else if ($eqeqeq("M", $ret_or_1)) {
            
            title = "ミュータント衝動表";
            urge = $$('MUTANT_TABLE');
          } else if ($eqeqeq("U", $ret_or_1)) {
            
            title = "鬼御魂(戦闘外)衝動表";
            urge = $$('ONIMITAMA_OUT_OF_BATTLE_TABLE');
          } else if ($eqeqeq("C", $ret_or_1)) {
...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $truthy = Opal.truthy, $eqeqeq = Opal.eqeqeq, $rb_gt = Opal.rb_gt, $rb_lt = Opal.rb_lt, $eqeq = Opal.eqeq, $rb_le = Opal.rb_le, $def = Opal.def, $rb_minus = Opal.rb_minus, self = Opal.top, $nesting = [], nil = Opal.nil;

  
  self.$require("bcdice/game_system/DemonParasite");
  return (function($base, $parent_nesting) {
    var self = $module($base, 'BCDice');
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $const_set($nesting[0], 'ID', "ParasiteBlood");
        $const_set($nesting[0], 'NAME', "パラサイトブラッドRPG");
        $const_set($nesting[0], 'SORT_KEY', "はらさいとふらつとRPG");
        $const_set($nesting[0], 'HELP_MESSAGE', "・衝動表　(URGEx)\n" + "　\"URGE衝動レベル\"の形で指定します。\n" + "　衝動表に従って自動でダイスロールを行い、結果を表示します。\n" + "　ダイスロールと同様に、他のプレイヤーに隠れてロールすることも可能です。\n" + "　頭に識別文字を追加して、デフォルト以外の衝動表もロールできます。\n" + "　・AURGEx　頭に「A」を付けると「誤作動表」。\n" + "例）URGE1　　　urge5　　　Aurge2\n" + "・D66ダイスあり\n");
        self.$register_prefix("[NAMUC]?URGE");
        
        $def(self, '$get_urge', function $$get_urge(string) {
          var self = this, initialWord = nil, urgelv = nil, $ret_or_1 = nil, urge_type = nil, dice_now = nil, urge = nil, resultText = nil, output = nil;
          ...
          if ($eqeqeq("", ($ret_or_1 = initialWord))) {
            urge_type = 1
          } else if ($eqeqeq(/A/i, $ret_or_1)) {
            urge_type = 2
          } else {
            urge_type = 1
          };
        ...
        $def(self, '$get_pb_urge_table', function $$get_pb_urge_table(level, dice, urge_type) {
        ...
        $def(self, '$get_pb_normal_urge_table', function $$get_pb_normal_urge_table() {
        ...
        return $def(self, '$get_pb_aas_urge_table', function $$get_pb_aas_urge_table() {
      ...
      })($nesting[0], $$('DemonParasite'), $nesting)
    })($nesting[0], $nesting)
  })($nesting[0], $nesting);
});
