...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $truthy = Opal.truthy, $to_ary = Opal.to_ary, $eqeqeq = Opal.eqeqeq, $def = Opal.def, $hash2 = Opal.hash2, $nesting = [], nil = Opal.nil;
  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        var self = $klass($base, $super, 'Nuekagami');

        var $nesting = [self].concat($parent_nesting), $$ = Opal.$r($nesting);

        
        $const_set($nesting[0], 'ID', "Nuekagami");
        $const_set($nesting[0], 'NAME', "鵺鏡");
        $const_set($nesting[0], 'SORT_KEY', "ぬえかかみ");
        $const_set($nesting[0], 'HELP_MESSAGE', "・喪失表（xL）\n" + "　BL：血脈、LL：生様、SL：魂魄、FL：因縁\n" + "・LR：喪失取戻表\n" + "・門通過描写表（xG）\n" + "　HG：地獄門、RG：羅生門、VG：朱雀門、OG：応天門\n");
