...
Opal.modules["bcdice/game_system/satasupe/tables"] = function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $hash = Opal.hash, $send = Opal.send, $rb_plus = Opal.rb_plus, $rb_minus = Opal.rb_minus, $hash2 = Opal.hash2, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $send2 = Opal.send2, $find_super = Opal.find_super, $def = Opal.def, $truthy = Opal.truthy, $to_ary = Opal.to_ary, $rb_gt = Opal.rb_gt, $rb_plus = Opal.rb_plus, $rb_minus = Opal.rb_minus, $rb_lt = Opal.rb_lt, $rb_ge = Opal.rb_ge, $send = Opal.send, $neqeq = Opal.neqeq, $eqeq = Opal.eqeq, $rb_le = Opal.rb_le, $thrower = Opal.thrower, $hash2 = Opal.hash2, $eqeqeq = Opal.eqeqeq, $rb_times = Opal.rb_times, self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;

  
  self.$require("bcdice/game_system/satasupe/tables");
  return (function($base, $parent_nesting) {
    var self = $module($base, 'BCDice');
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $def(self, '$checkRoll', function $$checkRoll(string) {
          var $a, $b, self = this, m = nil, roll_times = nil, target = nil, params = nil, min_suc = nil, fumble = nil, critical = nil, is_critical_stop = nil, result = nil, dice_str = nil, total_suc = nil, is_critical = nil, is_fumble = nil;
          ...
          target = m['$[]'](2).$to_i();
          params = m['$[]'](3);
          $b = self.$get_roll_params(params), $a = $to_ary($b), (min_suc = ($a[0] == null ? nil : $a[0])), (fumble = ($a[1] == null ? nil : $a[1])), (critical = ($a[2] == null ? nil : $a[2])), (is_critical_stop = ($a[3] == null ? nil : $a[3])), $b;
          result = "";
          ...
          if (($truthy($rb_lt(critical, 1)) || ($truthy($rb_gt(critical, 12))))) {
            critical = 13
          };
          if ($truthy($rb_ge(fumble, 6))) {
            
            result = $rb_plus(result, "" + (self.$get_judge_info(target, fumble, critical)) + " ＞ ファンブル率が6を超えたため自動失敗！");
          ...
          $b = self.$check_roll_loop(roll_times, min_suc, target, critical, fumble, is_critical_stop), $a = $to_ary($b), (dice_str = ($a[0] == null ? nil : $a[0])), (total_suc = ($a[1] == null ? nil : $a[1])), (is_critical = ($a[2] == null ? nil : $a[2])), (is_fumble = ($a[3] == null ? nil : $a[3])), $b;
          result = $rb_plus(result, "" + (self.$get_judge_info(target, fumble, critical)) + " ＞ " + (dice_str) + " ＞ 成功度" + (total_suc));
          if ($truthy(is_fumble)) {
            result = $rb_plus(result, " ＞ ファンブル")
          };
          if (($truthy(is_critical) && ($truthy($rb_gt(total_suc, 0))))) {
            result = $rb_plus(result, " ＞ 必殺発動可能！")
          };
          self.$debug("checkRoll result result", result);
          return $send($$('Result').$new(), 'tap', [], function $$1(r){var $c, $ret_or_1 = nil, $ret_or_2 = nil;

            
            if (r == null) r = nil;
            r['$text='](result);
            r['$success='](($truthy(($ret_or_1 = ($truthy(($ret_or_2 = is_fumble['$!']())) ? ($rb_gt(min_suc, 0)) : ($ret_or_2)))) ? ($rb_ge(total_suc, min_suc)) : ($ret_or_1)));
            r['$failure='](is_fumble);
            r['$critical='](is_critical);
            return ($c = [is_fumble], $send(r, 'fumble=', $c), $c[$c.length - 1]);});
        });
        
        $def(self, '$get_roll_params', function $$get_roll_params(params) {
          var min_suc = nil, fumble = nil, critical = nil, isCriticalStop = nil, m = nil;
        ...
        $def(self, '$get_judge_info', function $$get_judge_info(target, fumble, critical) {
          
          return "【難易度" + (target) + "、ファンブル率" + (fumble) + "、必殺" + (($eqeq(critical, 13) ? ("なし") : (critical.$to_s()))) + "】"
        });
        
        $def(self, '$check_roll_loop', function $$check_roll_loop(roll_times, min_suc, target, critical, fumble, is_critical_stop) {
          var self = this, dice_str = nil, is_fumble = nil, is_critical = nil, total_suc = nil;
          ...
          is_critical = false;
          total_suc = 0;
          (function(){try { var $t_break = $thrower('break'); return $send(roll_times, 'times', [], function $$2(_i){var self = $$2.$$s == null ? this : $$2.$$s, d1 = nil, d2 = nil, dice_suc = nil;
            ...
            if (($neqeq(min_suc, 0) && ($truthy($rb_ge(total_suc, min_suc))))) {
            ...
            if (($eqeq(d1, d2) && ($truthy($rb_le(d1, fumble))))) {
              
              is_fumble = true;
              is_critical = false;
              $t_break.$throw();
            };
            if (($truthy(is_critical) && ($truthy(is_critical_stop)))) {
              $t_break.$throw()
            } else {
              return nil
            };}, {$$s: self})} catch($e) {
        ...
        $def(self, '$check_seigou', function $$check_seigou(string) {
          var self = this, sr_parser = nil, cmd = nil, dice = nil, diceTotal = nil, target = nil, seigou = nil, result = nil;

          
          self.$debug("check_seigou begin string", string);
          sr_parser = $$$($$('Command'), 'Parser').$new("SR", $hash2(["round_type"], {"round_type": self.$round_type()})).$has_suffix_number().$restrict_cmp_op_to(nil);
          cmd = sr_parser.$parse(string);
          if (!$truthy(cmd)) {
            return ""
          };
          dice = self.randomizer.$roll_sum(2, 6);
          diceTotal = $rb_plus(dice, cmd.$modify_number());
          target = cmd.$suffix_number();
          seigou = ($truthy($rb_lt(target, diceTotal)) ? ("「激」") : ($truthy($rb_gt(target, diceTotal)) ? ("「律」") : ("「迷」")));
        ...
        $def(self, '$rollTableCommand', function $$rollTableCommand(command) {
          var self = this, result = nil, m = nil, counts = nil, operator = nil, value = nil;
          ...
          switch (command.valueOf()) {
            case "TAGT":
              result = self.$getTagTableResult(counts)
              break;
            case "GETSST":
              result = self.$getCreateSatasupeResult(counts)
              break;
            case "NPCT":
              result = self.$getNpcTableResult(counts)
              break;
            default:
              result = self.$getAnotherTableResult(command, counts, operator, value)
          };
          return result.$join("\n");
        });
        
        $def(self, '$getTagTableResult', function $$getTagTableResult(counts) {
          var self = this, result = nil;

          
          result = [];
          $send(counts, 'times', [], function $$3(_i){var self = $$3.$$s == null ? this : $$3.$$s, roll_result = nil;
            if (self.randomizer == null) self.randomizer = nil;

            
            if (_i == null) _i = nil;
            roll_result = $$('TAG_TABLE').$roll(self.randomizer);
            return result.$push("" + (roll_result.$table_name()) + ":" + (roll_result.$value()) + ":" + (roll_result.$body()));}, {$$s: self});
          return result;
        });
        
        $def(self, '$getCreateSatasupeResult', function $$getCreateSatasupeResult(counts) {
          var self = this, name = nil, arm = nil, $ret_or_1 = nil, result = nil, text = nil;

          
          self.$debug("getCreateSatasupeResult counts", counts);
          name = "サタスペ作成";
          arm = ($eqeqeq(1, ($ret_or_1 = self.randomizer.$roll_once(6))) ? ($$('CREATE_ARMS_STRUCT').$new("「紙製の筒」", [], ["「命中：10、ダメージ：3、耐久度1」"], 10, 3, 1, 0, 0, [])) : ($eqeqeq(2, $ret_or_1) ? ($$('CREATE_ARMS_STRUCT').$new("「木製の筒」", [], ["「命中：9、ダメージ：3、耐久度2」"], 9, 3, 2, 0, 0, [])) : ($eqeqeq(3, $ret_or_1) ? ($$('CREATE_ARMS_STRUCT').$new("「小型のプラスチック製の筒」", [], ["「命中：9、ダメージ：4、耐久度2」"], 9, 4, 2, 0, 0, [])) : ($eqeqeq(4, $ret_or_1) ? ($$('CREATE_ARMS_STRUCT').$new("「大型のプラスチック製の筒」", [], ["「命中：8、ダメージ：3、耐久度2、両手」"], 8, 3, 2, 0, 0, ["「両手」"])) : ($eqeqeq(5, $ret_or_1) ? ($$('CREATE_ARMS_STRUCT').$new("「小型の金属製の筒」", [], ["「命中：9、ダメージ：4、耐久度3」"], 9, 4, 3, 0, 0, [])) : ($eqeqeq(6, $ret_or_1) ? ($$('CREATE_ARMS_STRUCT').$new("「大型の金属製の筒」", [], ["「命中：8、ダメージ：5、耐久度3、両手」"], 8, 5, 3, 0, 0, ["「両手」"])) : (nil)))))));
          $send(counts, 'times', [], function $$4(_i){var $a, $b, self = $$4.$$s == null ? this : $$4.$$s, part = nil, effect = nil, modifier = nil;
            if (self.randomizer == null) self.randomizer = nil;

            
            if (_i == null) _i = nil;
            $b = $$('CREATE_ARMS_ACCESSORY_TABLE')['$[]'](self.randomizer.$roll_d66($$$($$('D66SortType'), 'ASC'))), $a = $to_ary($b), (part = ($a[0] == null ? nil : $a[0])), (effect = ($a[1] == null ? nil : $a[1])), (modifier = ($a[2] == null ? nil : $a[2])), $b;
            arm.$accessory_parts()['$<<'](part);
            arm.$parts_effect()['$<<'](effect);
            return modifier.$call(arm, self.randomizer);}, {$$s: self});
          result = [];
          ...
          if ($truthy($rb_gt(arm.$kutibeni(), 0))) {
            text = $rb_plus(text, "「（判定前宣言）" + (arm.$kutibeni()) + "回だけ、必殺10」")
          };
          if ($truthy($rb_gt(arm.$kiba(), 0))) {
            text = $rb_plus(text, "「（判定前宣言）" + (arm.$kiba()) + "回だけ、ダメージ＋２」")
          };
          text = $rb_plus(text, arm.$abilities().$sort().$uniq().$join());
          text = $rb_plus(text, "「サタスペ" + (counts) + "」「耐久度" + (arm.$life()) + "」）");
          result.$push(text);
          return result;
        });
        
        $def(self, '$getNpcTableResult', function $$getNpcTableResult(counts) {
          var self = this, name = nil, result = nil;

          
          name = "NPC表:";
          result = [];
          $send(counts, 'times', [], function $$5(_i){var $a, $b, self = $$5.$$s == null ? this : $$5.$$s, age = nil, agen_const = nil, agen_times = nil, ysold = nil, lmodValue = nil, lageValue = nil, text = nil;
            if (self.randomizer == null) self.randomizer = nil;

            
            if (_i == null) _i = nil;
            $b = $$('NPC_AGE_TABLE')['$[]'](self.randomizer.$roll_index(6)), $a = $to_ary($b), (age = ($a[0] == null ? nil : $a[0])), (agen_const = ($a[1] == null ? nil : $a[1])), (agen_times = ($a[2] == null ? nil : $a[2])), $b;
            ysold = $rb_plus(self.randomizer.$roll_sum(agen_times, 6), agen_const);
            lmodValue = $$('NPC_LMOOD_TABLE')['$[]'](self.randomizer.$roll_index(6));
            lageValue = $$('NPC_LAGE_TABLE')['$[]'](self.randomizer.$roll_index(3));
            text = "" + (name) + (age) + "(" + (ysold) + "歳):" + (lmodValue) + (lageValue);
            return result.$push(text);}, {$$s: self});
          return result;
        });
        
        $def(self, '$getAnotherTableResult', function $$getAnotherTableResult(command, counts, operator, value) {
          var self = this, result = nil, table_name = nil, $ret_or_1 = nil, table = nil;

          
          result = [];
          table_name = ($truthy(($ret_or_1 = $$('ALIASES')['$[]'](command))) ? ($ret_or_1) : (command));
          table = $$('TABLES')['$[]'](table_name);
          if ($truthy(table['$nil?']())) {
            return result
          };
          $send(counts, 'times', [], function $$6(_i){var $a, $b, self = $$6.$$s == null ? this : $$6.$$s, _ = nil, index = nil, info = nil, text = nil;

            
            if (_i == null) _i = nil;
            $b = self.$getTableIndex(operator, value, 2, 6), $a = $to_ary($b), (_ = ($a[0] == null ? nil : $a[0])), (index = ($a[1] == null ? nil : $a[1])), $b;
            info = table.$choice(index);
            text = "" + (info.$table_name()) + ":" + (info.$value()) + ":" + (info.$body());
            return result.$push(text);}, {$$s: self});
          return result;
        });
        return $def(self, '$getTableIndex', function $$getTableIndex(operator, value, diceCount, diceType) {
          var self = this, index = nil, modify = nil;
          ...
          if ($truthy(index['$nil?']())) {
            ...
            index = self.randomizer.$roll_sum(diceCount, diceType);
