...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $send2 = Opal.send2, $find_super = Opal.find_super, $def = Opal.def, $truthy = Opal.truthy, $hash2 = Opal.hash2, $rb_plus = Opal.rb_plus, $rb_le = Opal.rb_le, $rb_ge = Opal.rb_ge, $to_ary = Opal.to_ary, $send = Opal.send, $thrower = Opal.thrower, $rb_times = Opal.rb_times, $eqeqeq = Opal.eqeqeq, self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        var self = $klass($base, $super, 'ColossalHunter');

        var $nesting = [self].concat($parent_nesting), $$ = Opal.$r($nesting), $proto = self.$$prototype;

        $proto.randomizer = nil;
        
        $const_set($nesting[0], 'ID', "ColossalHunter");
        $const_set($nesting[0], 'NAME', "コロッサルハンター");
        $const_set($nesting[0], 'SORT_KEY', "ころつさるはんたあ");
        $const_set($nesting[0], 'HELP_MESSAGE', "・判定（nCH±x>=y)\n" + "　nD6の判定。クリティカル、ファンブルの自動判定を行います。\n" + "　n：ダイス数。省略可能。省略した場合3。\n" + "　x：修正値。省略可能。\n" + "　y：目標値。省略可能。\n" + "　例） CH　CH+1　CH+2>=10　4CH+1\n" + "・BIG-6表(B6T)\n" + "・覚醒表(AWT)\n" + "・現状表(CST)\n" + "・ハンターマーク表(HMT)\n" + "・特徴表(SPT)\n" + "・プレシャス表(PRT)\n" + "・専門能力表(EXT)\n" + "・コロッサル行動表(CAT)\n" + "・NPC作成表(CNP)\n" + "・D66ダイスあり\n");
        ...
        $def(self, '$eval_game_system_specific_command', function $$eval_game_system_specific_command(command) {
          ...
          if ($truthy(($ret_or_1 = ($truthy(($ret_or_2 = ($truthy(($ret_or_3 = self.$getCheckRollDiceCommandResult(command))) ? ($ret_or_3) : (self.$getSourceSceneDiceCommandResult(command))))) ? ($ret_or_2) : (self.$getCreateNpcDiceCommandResult(command)))))) {
            return $ret_or_1
          } else {
        ...
        $def(self, '$getCheckRollDiceCommandResult', function $$getCheckRollDiceCommandResult(command) {
          var self = this, parser = nil, parsed = nil, dice_count = nil, modify = nil, dice_list = nil, dice = nil, dice_str = nil, total = nil, text = nil, result = nil;

          
          self.$debug("getCheckRollDiceCommandResult command", command);
          parser = $$$($$('Command'), 'Parser').$new(/\d*CH/, $hash2(["round_type"], {"round_type": self.$round_type()})).$restrict_cmp_op_to(nil, ">=");
          parsed = parser.$parse(command);
          if (!$truthy(parsed)) {
            return nil
          };
          if (!$truthy(parsed.$command()['$start_with?'](/\d/))) {
            parsed['$command=']("3CH")
          };
          ...
          result = self.$get_judge_result(dice, total, parsed, text);
          return result;
        });
        
        $def(self, '$get_judge_result', function $$get_judge_result(dice, total, parsed, text) {
          
          if ($truthy($rb_le(dice, 5))) {
            return $$('Result').$fumble($rb_plus(text, " ＞ ファンブル"))
          } else if ($truthy($rb_ge(total, 16))) {
            return $$('Result').$critical($rb_plus(text, " ＞ クリティカル"))
        ...
        $def(self, '$getSourceSceneDiceCommandResult', function $$getSourceSceneDiceCommandResult(command) {
          var self = this, name = nil, table = nil, yearTitle = nil;

          
          if (!$truthy(command['$=~'](/^B6T$/))) {
            return nil
          };
          name = "BIG-6表";
        ...
        $def(self, '$getYearTableResult', function $$getYearTableResult(name, table, yearTitle) {
          var $a, $b, self = this, item = nil, index = nil, title = nil, text = nil, yearText = nil, year = nil, calculateText = nil, result = nil;

          
          $b = self.$get_table_by_d66(table), $a = $to_ary($b), (item = ($a[0] == null ? nil : $a[0])), (index = ($a[1] == null ? nil : $a[1])), $b;
          if ($truthy(item['$nil?']())) {
            return nil
          };
          $b = item, $a = $to_ary($b), (title = ($a[0] == null ? nil : $a[0])), (text = ($a[1] == null ? nil : $a[1])), (yearText = ($a[2] == null ? nil : $a[2])), $b;
          self.$debug("yearText", yearText);
          $b = self.$getYear(yearText), $a = $to_ary($b), (year = ($a[0] == null ? nil : $a[0])), (calculateText = ($a[1] == null ? nil : $a[1])), $b;
        ...
        $def(self, '$getYear', function $$getYear(yearText) {try { var $t_eval_return = $thrower('eval_return'); 
          var self = this, text = nil, year = nil;

          
          text = $send(yearText, 'gsub', [/(\d+)D(6+)/], function $$1(){var self = $$1.$$s == null ? this : $$1.$$s;

            return self.$getD6xResult($$('Regexp').$last_match(1).$to_i(), $$('Regexp').$last_match(2).$length())}, {$$s: self});
          if (!$truthy(text['$match?'](/^[+\-*\/\d]+$/))) {
            return nil
          };
          if ($truthy(text['$match?'](/^\d+$/))) {
            return nil
          ...
          return [year, "(" + (text) + ")"];} catch($e) {
            if ($e === Opal.t_eval_return) return $e.$v;
            throw $e;
          }
        });
        
        $def(self, '$getD6xResult', function $$getD6xResult(count, dice6Count) {
          var self = this, total = nil;

          
          total = 0;
          $send(count, 'times', [], function $$2(_i){var self = $$2.$$s == null ? this : $$2.$$s, number = nil;

            
            if (_i == null) _i = nil;
            number = 0;
            $send(dice6Count, 'times', [], function $$3(_i){var self = $$3.$$s == null ? this : $$3.$$s, dice = nil;
              ...
              return (number = $rb_plus(number, dice));}, {$$s: self});
            return (total = $rb_plus(total, number));}, {$$s: self});
          return total.$to_s();
        });
        
        $def(self, '$getBig6Table', function $$getBig6Table() {
          var table = nil;
        ...
        $def(self, '$getCreateNpcDiceCommandResult', function $$getCreateNpcDiceCommandResult(command) {
          ...
          $b = self.$getD66Item(table, 0), $a = $to_ary($b), (nature = ($a[0] == null ? nil : $a[0])), (nature_number = ($a[1] == null ? nil : $a[1])), $b;
          $b = self.$getD66Item(table, 1), $a = $to_ary($b), (type = ($a[0] == null ? nil : $a[0])), (type_number = ($a[1] == null ? nil : $a[1])), $b;
          $b = self.$getD66Item(table, 2), $a = $to_ary($b), (secret = ($a[0] == null ? nil : $a[0])), (secret_number = ($a[1] == null ? nil : $a[1])), $b;
          result = "" + (name) + "(" + (nature_number) + ", " + (type_number) + ", " + (secret_number) + ") ＞ 性質：" + (nature) + "／タイプ：" + (type) + "／心の秘密：" + (secret);
          return result;
        });
        
        $def(self, '$getD66Item', function $$getD66Item(table, index) {
          var $a, $b, self = this, item = nil, number = nil;

          
          $b = self.$get_table_by_d66(table), $a = $to_ary($b), (item = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
          return [item['$[]'](index), number];
        });
        
        $def(self, '$getTableDiceCommandResult', function $$getTableDiceCommandResult(command) {
          var $a, $b, self = this, info = nil, name = nil, type = nil, table = nil, $ret_or_1 = nil, text = nil, number = nil;
