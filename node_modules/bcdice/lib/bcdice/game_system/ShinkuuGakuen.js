...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $truthy = Opal.truthy, $def = Opal.def, $rb_plus = Opal.rb_plus, $rb_ge = Opal.rb_ge, $send = Opal.send, $eqeq = Opal.eqeq, $thrower = Opal.thrower, $rb_le = Opal.rb_le, $neqeq = Opal.neqeq, $hash2 = Opal.hash2, $rb_times = Opal.rb_times, $nesting = [], nil = Opal.nil;
  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $const_set($nesting[0], 'ID', "ShinkuuGakuen");
        $const_set($nesting[0], 'NAME', "真空学園");
        $const_set($nesting[0], 'SORT_KEY', "しんくうかくえん");
        ...
        self.$register_prefix("CRL", "CSW", "CLS", "CSS", "CSP", "CAX", "CCL", "CMA", "CBX", "CPR", "CST", "RL", "SW", "LS", "SS", "SP", "AX", "CL", "BW", "MA", "BX", "PR", "ST");
        
        $def(self, '$eval_game_system_specific_command', function $$eval_game_system_specific_command(command) {
          var self = this, m = nil, weaponCommand = nil, base = nil, diff = nil, weaponInfo = nil, output_msg = nil;
        ...
        $def(self, '$rollJudge', function $$rollJudge(base, diff, weaponInfo) {
          var self = this, weaponName = nil, weaponTable = nil, diceList = nil, total = nil, allTotal = nil, diffText = nil, result = nil;
        ...
        $def(self, '$getJudgeDiceList', function $$getJudgeDiceList() {
          var self = this, diceList = nil;

          
          diceList = [];
          (function(){try { var $t_break = $thrower('break'); return $send(self, 'loop', [], function $$1(){var self = $$1.$$s == null ? this : $$1.$$s, value = nil, rank01 = nil;
            if (self.randomizer == null) self.randomizer = nil;

            
            value = self.randomizer.$roll_once(100);
            diceList['$<<'](value);
            rank01 = value['$%'](10);
        ...
        $def(self, '$getSuccessText', function $$getSuccessText(allTotal, diff, diceList, isWeapon) {
          var self = this, first = nil, result = nil, skillText = nil, success = nil;
          ...
          if (($truthy(diff['$nil?']()) && ($neqeq(first, 10)))) {
            return ""
          };
          result = "";
          ...
          if (!$truthy(diff['$nil?']())) {
            ...
            success = ($truthy($rb_ge(allTotal, diff.$to_i())) ? ("成功") : ("失敗"));
            result = $rb_plus(result, success.$to_s());
          };
          return result;
        });
        
        $def(self, '$getSkillText', function $$getSkillText(first, diff, isWeapon) {
          var result = nil;
        ...
        $def(self, '$getWeaponTable', function $$getWeaponTable(weaponCommand) {
          var self = this;

          
          self.$debug("getWeaponTable weaponCommand", weaponCommand);
          
          switch (weaponCommand.$upcase().valueOf()) {
            case "SW":
              return self.$getWeaponTableSword()
            case "CSW":
              return self.$getWeaponTableSwordCounter()
            case "LS":
              return self.$getWeaponTableLongSword()
            case "CLS":
              return self.$getWeaponTableLongSwordCounter()
            case "SS":
              return self.$getWeaponTableShortSword()
            case "CSS":
              return self.$getWeaponTableShortSwordCounter()
            case "SP":
              return self.$getWeaponTableSpear()
            case "CSP":
              return self.$getWeaponTableSpearCounter()
            case "AX":
              return self.$getWeaponTableAx()
            case "CAX":
              return self.$getWeaponTableAxCounter()
            case "CL":
              return self.$getWeaponTableClub()
            case "CCL":
              return self.$getWeaponTableClubCounter()
            case "BW":
              return self.$getWeaponTableBow()
            case "MA":
              return self.$getWeaponTableMartialArt()
            case "CMA":
              return self.$getWeaponTableMartialArtCounter()
            case "BX":
              return self.$getWeaponTableBoxing()
            case "CBX":
              return self.$getWeaponTableBoxingCounter()
            case "PR":
              return self.$getWeaponTableProWrestling()
            case "CPR":
              return self.$getWeaponTableProWrestlingCounter()
            case "ST":
              return self.$getWeaponTableStand()
            case "CST":
              return self.$getWeaponTableStandCounter()
            default:
              nil
          };
        ...
        $def(self, '$getWeaponTableSword', function $$getWeaponTableSword() {
        ...
        $def(self, '$getWeaponTableSwordCounter', function $$getWeaponTableSwordCounter() {
        ...
        $def(self, '$getWeaponTableLongSword', function $$getWeaponTableLongSword() {
        ...
        $def(self, '$getWeaponTableLongSwordCounter', function $$getWeaponTableLongSwordCounter() {
        ...
        $def(self, '$getWeaponTableShortSword', function $$getWeaponTableShortSword() {
        ...
        $def(self, '$getWeaponTableShortSwordCounter', function $$getWeaponTableShortSwordCounter() {
        ...
        $def(self, '$getWeaponTableSpear', function $$getWeaponTableSpear() {
        ...
        $def(self, '$getWeaponTableSpearCounter', function $$getWeaponTableSpearCounter() {
          
          return $hash2(["name", "table"], {"name": "槍カウンター", "table": [[55, "風車", "カウンター、ダメージ２倍"], [66, nil, nil], [77, nil, nil], [88, nil, nil], [99, nil, nil], [0, nil, nil]]})
        });
        
        $def(self, '$getWeaponTableAx', function $$getWeaponTableAx() {
        ...
        $def(self, '$getWeaponTableAxCounter', function $$getWeaponTableAxCounter() {
        ...
        $def(self, '$getWeaponTableClub', function $$getWeaponTableClub() {
        ...
        $def(self, '$getWeaponTableClubCounter', function $$getWeaponTableClubCounter() {
        ...
        $def(self, '$getWeaponTableBow', function $$getWeaponTableBow() {
        ...
        $def(self, '$getWeaponTableMartialArt', function $$getWeaponTableMartialArt() {
        ...
        $def(self, '$getWeaponTableMartialArtCounter', function $$getWeaponTableMartialArtCounter() {
          var self = this;
        ...
        $def(self, '$getRandMartialArtCounter', function $$getRandMartialArtCounter() {
          var self = this, value = nil, dice = nil, tableInfo = nil, weaponTable = nil, result = nil;
        ...
        $def(self, '$getWeaponTableBoxing', function $$getWeaponTableBoxing() {
        ...
        $def(self, '$getWeaponTableBoxingCounter', function $$getWeaponTableBoxingCounter() {
        ...
        $def(self, '$getWeaponTableProWrestling', function $$getWeaponTableProWrestling() {
        ...
        $def(self, '$getWeaponTableProWrestlingCounter', function $$getWeaponTableProWrestlingCounter() {
        ...
        $def(self, '$getWeaponTableStand', function $$getWeaponTableStand() {
        ...
        $def(self, '$getWeaponTableStandCounter', function $$getWeaponTableStandCounter() {
        ...
        return $def(self, '$getWeaponSkillText', function $$getWeaponSkillText(weaponTable, dice) {try { var $t_return = $thrower('return'); 
          var self = this, preName = nil, preEffect = nil;
          ...
          preName = "";
          preEffect = "";
          $send(weaponTable, 'each', [], function $$2(index, name, effect){var $ret_or_1 = nil;

            
            if (index == null) index = nil;
            if (name == null) name = nil;
            if (effect == null) effect = nil;
            name = ($truthy(($ret_or_1 = name)) ? ($ret_or_1) : (preName));
            preName = name;
            effect = ($truthy(($ret_or_1 = effect)) ? ($ret_or_1) : (preEffect));
            preEffect = effect;
            if (!$eqeq(index, dice['$%'](100))) {
              return nil
            };
            $t_return.$throw(" ＞ 「" + (name) + "」" + (effect));}, {$$ret: $t_return});
          return "";} catch($e) {
