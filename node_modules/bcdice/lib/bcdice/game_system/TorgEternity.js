...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $truthy = Opal.truthy, $def = Opal.def, $send = Opal.send, $to_ary = Opal.to_ary, $rb_gt = Opal.rb_gt, $rb_plus = Opal.rb_plus, $neqeq = Opal.neqeq, $thrower = Opal.thrower, $eqeq = Opal.eqeq, $rb_le = Opal.rb_le, $rb_lt = Opal.rb_lt, $rb_minus = Opal.rb_minus, $rb_divide = Opal.rb_divide, $nesting = [], nil = Opal.nil;
  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $const_set($nesting[0], 'ID', "TorgEternity");
        $const_set($nesting[0], 'NAME', "トーグ エタニティ");
        $const_set($nesting[0], 'SORT_KEY', "とおくえたにてい");
        ...
        self.$register_prefix("TE", "UP", "POS", "CPOS", "\\d+BD", "TG", "RT", "Result", "DT", "damage", "BT", "bonus", "total", "1R20");
        ...
        $def(self, '$eval_game_system_specific_command', function $$eval_game_system_specific_command(command) {
          ...
          if ($truthy(($ret_or_1 = ($truthy(($ret_or_2 = ($truthy(($ret_or_3 = ($truthy(($ret_or_4 = ($truthy(($ret_or_5 = ($truthy(($ret_or_6 = ($truthy(($ret_or_7 = ($truthy(($ret_or_8 = self.$torg_check(command))) ? ($ret_or_8) : (self.$getRolld20DiceCommandResult(command))))) ? ($ret_or_7) : (self.$getUpRollDiceCommandResult(command))))) ? ($ret_or_6) : (self.$getPossibilityRollDiceCommandResult(command))))) ? ($ret_or_5) : (self.$getCosmPossibilityRollDiceCommandResult(command))))) ? ($ret_or_4) : (self.$getBonusDamageDiceCommandResult(command))))) ? ($ret_or_3) : (self.$getSuccessLevelDiceCommandResult(command))))) ? ($ret_or_2) : (self.$getDamageResultDiceCommandResult(command)))))) {
            return $ret_or_1
          } else {
        ...
        $def(self, '$torg_check', function $$torg_check(string) {try { var $t_eval_return = $thrower('eval_return'); 
          ...
          mod = m['$[]'](1);
          self.$debug(mod);
          mod = ($truthy(mod) ? ($$('Arithmetic').$eval(mod, self.round_type)) : (0));
          self.$debug(mod);
          mod = mod.$to_i();
          $b = self.$torg_eternity_dice(false, false), $a = $to_ary($b), (skilled = ($a[0] == null ? nil : $a[0])), (unskilled = ($a[1] == null ? nil : $a[1])), (dice_str = ($a[2] == null ? nil : $a[2])), $b;
        ...
        $def(self, '$getRolld20DiceCommandResult', function $$getRolld20DiceCommandResult(command) {
          var $a, $b, self = this, skilled = nil, unskilled = nil, dice_str = nil, mishap = nil, output = nil, value_skilled = nil, value_unskilled = nil;
          ...
          $b = self.$torg_eternity_dice(false, true), $a = $to_ary($b), (skilled = ($a[0] == null ? nil : $a[0])), (unskilled = ($a[1] == null ? nil : $a[1])), (dice_str = ($a[2] == null ? nil : $a[2])), (mishap = ($a[3] == null ? nil : $a[3])), $b;
          if ($eqeq(mishap, 1)) {
        ...
        $def(self, '$getUpRollDiceCommandResult', function $$getUpRollDiceCommandResult(command) {
          var $a, $b, self = this, m = nil, sequence = nil, mod = nil, skilled1 = nil, unskilled1 = nil, dice_str1 = nil, mishap = nil, skilled2 = nil, unskilled2 = nil, dice_str2 = nil, subtotal_skilled = nil, subtotal_unskilled = nil, value_skilled = nil, value_unskilled = nil, output = nil;
          ...
          sequence = [];
          mod = m['$[]'](1).$to_i();
          $b = self.$torg_eternity_dice(false, true), $a = $to_ary($b), (skilled1 = ($a[0] == null ? nil : $a[0])), (unskilled1 = ($a[1] == null ? nil : $a[1])), (dice_str1 = ($a[2] == null ? nil : $a[2])), (mishap = ($a[3] == null ? nil : $a[3])), $b;
          if ($eqeq(mishap, 1)) {
            sequence = ["d20ロール（高揚）", "1d20[" + (dice_str1) + "]", "Mishap!　絶対失敗！"].$compact()
          } else {
            
            $b = self.$torg_eternity_dice(false, false), $a = $to_ary($b), (skilled2 = ($a[0] == null ? nil : $a[0])), (unskilled2 = ($a[1] == null ? nil : $a[1])), (dice_str2 = ($a[2] == null ? nil : $a[2])), $b;
            ...
            if ($truthy($rb_le(mod, 0))) {
              if ($neqeq(subtotal_skilled, subtotal_unskilled)) {
                sequence = ["d20ロール（高揚）", "1d20[" + (dice_str1) + "] + 1d20[" + (dice_str2) + "]", "" + (value_skilled) + "[" + (subtotal_skilled) + "]（技能有） / " + (value_unskilled) + "[" + (subtotal_unskilled) + "]（技能無）"].$compact()
              } else {
                sequence = ["d20ロール（高揚）", "1d20[" + (dice_str1) + "] + 1d20[" + (dice_str2) + "]", "" + (value_skilled) + "[" + (subtotal_skilled) + "]"].$compact()
              }
            } else if ($neqeq(subtotal_skilled, subtotal_unskilled)) {
              sequence = ["d20ロール（高揚）", "1d20[" + (dice_str1) + "] + 1d20[" + (dice_str2) + "] + " + (mod), "" + (value_skilled) + "[" + (subtotal_skilled) + "]+" + (mod) + "（技能有） / " + (value_unskilled) + "[" + (subtotal_unskilled) + "]+" + (mod) + "（技能無）", $rb_plus($rb_plus($rb_plus(self.$format("%+d", $rb_plus(value_skilled.$to_i(), mod)), "（技能有） / "), self.$format("%+d", $rb_plus(value_unskilled.$to_i(), mod))), "（技能無）")].$compact()
            } else {
              sequence = ["d20ロール（高揚）", "1d20[" + (dice_str1) + "] + 1d20[" + (dice_str2) + "] + " + (mod), "" + (value_skilled) + "[" + (subtotal_skilled) + "]+" + (mod), self.$format("%+d", $rb_plus(value_skilled.$to_i(), mod))].$compact()
            };
          };
        ...
        $def(self, '$getPossibilityRollDiceCommandResult', function $$getPossibilityRollDiceCommandResult(command) {try { var $t_eval_return = $thrower('eval_return'); 
          ...
          output_modifier = ($truthy(m['$[]'](1)) ? ($$('Arithmetic').$eval(m['$[]'](1), self.round_type)) : (0));
          $b = self.$torg_eternity_dice(true, false), $a = $to_ary($b), (skilled = ($a[0] == null ? nil : $a[0])), (unskilled = ($a[1] == null ? nil : $a[1])), (dice_str = ($a[2] == null ? nil : $a[2])), $b;
        ...
        $def(self, '$getCosmPossibilityRollDiceCommandResult', function $$getCosmPossibilityRollDiceCommandResult(command) {try { var $t_eval_return = $thrower('eval_return'); 
          var $a, $b, self = this, m = nil, output_modifier = nil, skilled = nil, unskilled = nil, dice_str = nil, subtotal_skilled = nil, subtotal_unskilled = nil, value_skilled = nil, value_unskilled = nil, output = nil;

          
          self.$debug("Torg Eternity CosmPossibility Roll Command ? ", command);
        ...
        $def(self, '$getBonusDamageDiceCommandResult', function $$getBonusDamageDiceCommandResult(command) {
          ...
          $b = self.$get_torg_eternity_modifier(m['$[]'](3)), $a = $to_ary($b), (value_modifier = ($a[0] == null ? nil : $a[0])), (output_modifier = ($a[1] == null ? nil : $a[1])), $b;
          if ($truthy($rb_le(number_bonus_die, 0))) {
            output = "エラーです。xBD (x≧1) として下さい"
          } else {
            
            $b = self.$get_torg_eternity_damage_bonus_dice(number_bonus_die), $a = $to_ary($b), (value_roll = ($a[0] == null ? nil : $a[0])), (output_roll = ($a[1] == null ? nil : $a[1])), $b;
        ...
        $def(self, '$getSuccessLevelDiceCommandResult', function $$getSuccessLevelDiceCommandResult(command) {try { var $t_eval_return = $thrower('eval_return'); 
          ...
          value = ($truthy(m['$[]'](2)) ? ($$('Arithmetic').$eval(m['$[]'](2), self.round_type)) : (0));
          self.$debug(value);
        ...
        $def(self, '$getDamageResultDiceCommandResult', function $$getDamageResultDiceCommandResult(command) {try { var $t_eval_return = $thrower('eval_return'); 
          var self = this, m = nil, value = nil, output = nil;
        ...
        $def(self, '$getRollBonusDiceCommandResult', function $$getRollBonusDiceCommandResult(command) {
        ...
        $def(self, '$get_torg_eternity_table_result', function $$get_torg_eternity_table_result(value, table) {
          var output = nil;
        ...
        $def(self, '$get_torg_eternity_modifier', function $$get_torg_eternity_modifier(string_modifier) {try { var $t_eval_return = $thrower('eval_return'); 
          var self = this, value_modifier = nil, output_modifier = nil;

          
          self.$debug("modifier check : " + (string_modifier));
          if ($eqeq(string_modifier, "")) {
            
            value_modifier = 0;
            output_modifier = "";
          } else {
            
            value_modifier = ($truthy(string_modifier) ? ($$('Arithmetic').$eval(string_modifier, self.round_type)) : (0));
            output_modifier = self.$format("%+d", value_modifier);
          };
          self.$debug(value_modifier);
          self.$debug(output_modifier);
          return [value_modifier, output_modifier];} catch($e) {
            if ($e === Opal.t_eval_return) return $e.$v;
            throw $e;
          }
        });
        
        $def(self, '$torg_eternity_dice', function $$torg_eternity_dice(check_pos, check_mishap) {
          var self = this, isSkilledCritical = nil, isCritical = nil, skilled = nil, unskilled = nil, mishap = nil, dice_str = nil, dice_n = nil, dice_str_now = nil;
        ...
        $def(self, '$get_torg_eternity_damage_bonus_dice', function $$get_torg_eternity_damage_bonus_dice(number) {
          var self = this, value_roll = nil, output_roll = nil, dice_value = nil, dice_text = nil;
        ...
        $def(self, '$get_torg_eternity_success_level', function $$get_torg_eternity_success_level(value) {
        ...
        $def(self, '$get_torg_eternity_damage_result', function $$get_torg_eternity_damage_result(value) {
        ...
        return $def(self, '$get_torg_eternity_bonus', function $$get_torg_eternity_bonus(value) {
