...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $truthy = Opal.truthy, $def = Opal.def, $send = Opal.send, $rb_le = Opal.rb_le, $rb_plus = Opal.rb_plus, $rb_gt = Opal.rb_gt, $thrower = Opal.thrower, $hash2 = Opal.hash2, $range = Opal.range, self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $const_set($nesting[0], 'ID', "AnimaAnimus");
        $const_set($nesting[0], 'NAME', "アニマアニムス");
        $const_set($nesting[0], 'SORT_KEY', "あにまあにむす");
        $const_set($nesting[0], 'HELP_MESSAGE', "・行為判定(xAN<=y±z)\n" + "　十面ダイスをx個振って判定します。達成値が算出されます(クリティカル発生時は2増加)。\n" + "　x：振るダイスの数。魂魄値や攻撃値。\n" + "　y：成功値。\n" + "　z：成功値への補正。省略可能。\n" + "　(例) 2AN<=3+1 5AN<=7\n" + "・各種表\n" + "　情報収集表　IGT/喪失表　LT\n");
        ...
        $def(self, '$eval_game_system_specific_command', function $$eval_game_system_specific_command(command) {
          ...
          if ($truthy($$('TABLES')['$key?'](command))) {
            return self.$roll_tables(command, $$('TABLES'))
          } else if ($truthy(m)) {
            return self.$check_action(m)
          } else {
            return nil
          };
        });
        
        $def(self, '$check_action', function $$check_action(match_data) {try { var $t_eval_return = $thrower('eval_return'); 
          var self = this, dice_cnt = nil, target = nil, dice_arr = nil, dice_str = nil, suc_cnt = nil, has_critical = nil, result = nil;
