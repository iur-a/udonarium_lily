...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $send2 = Opal.send2, $find_super = Opal.find_super, $def = Opal.def, $eqeqeq = Opal.eqeqeq, $truthy = Opal.truthy, $rb_plus = Opal.rb_plus, $eqeq = Opal.eqeq, $rb_gt = Opal.rb_gt, $rb_lt = Opal.rb_lt, $rb_ge = Opal.rb_ge, $rb_divide = Opal.rb_divide, $rb_minus = Opal.rb_minus, $rb_times = Opal.rb_times, $to_ary = Opal.to_ary, $send = Opal.send, $regexp = Opal.regexp, $hash2 = Opal.hash2, $hash = Opal.hash, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $def(self, '$checkAnyCommand', function $$checkAnyCommand(command) {
          var self = this, result = nil, $ret_or_1 = nil, level = nil;

          
          result = ($eqeqeq("RBT", ($ret_or_1 = command.$upcase())) ? (self.$getClassRoomBreakTable()) : ($eqeqeq("SBT", $ret_or_1) ? (self.$getSchoolStoreBrakeTable()) : ($eqeqeq("BBT", $ret_or_1) ? (self.$getClubRoomBrakeTable()) : ($eqeqeq("CBT", $ret_or_1) ? (self.$getStudentCouncilBrakeTable()) : ($eqeqeq("DBT", $ret_or_1) ? (self.$getDormitoryBrakeTable()) : ($eqeqeq("IBT", $ret_or_1) ? (self.$getLibraryBrakeTable()) : ($eqeqeq("FBT", $ret_or_1) ? (self.$getRoofBrakeTable()) : ($eqeqeq("LBT", $ret_or_1) ? (self.$getLaboratoryBrakeTable()) : ($eqeqeq("PBT", $ret_or_1) ? (self.$getPoolBrakeTable()) : ($eqeqeq("NBT", $ret_or_1) ? (self.$getInnerCourtBrakeTable()) : ($eqeqeq("ABT", $ret_or_1) ? (self.$getShoppingAvenueBrakeTable()) : ($eqeqeq("VBT", $ret_or_1) ? (self.$getDevastationBrakeTable()) : ($eqeqeq("GBT", $ret_or_1) ? (self.$getGateBrakeTable()) : ($eqeqeq("BFT", $ret_or_1) ? (self.$getBattleFieldTable()) : ($eqeqeq("FWT", $ret_or_1) ? (self.$getFatalWoundsTable()) : ($eqeqeq("FT", $ret_or_1) ? (self.$getFumbleTable()) : ($eqeqeq("SRT", $ret_or_1) ? (self.$getRandomNpcSchoolLife()) : ($eqeqeq("ORT", $ret_or_1) ? (self.$getRandomNpcOther()) : ($eqeqeq("DRT", $ret_or_1) ? (self.$getRandomNpcDownClassmen()) : ($eqeqeq("URT", $ret_or_1) ? (self.$getRandomNpcUpperClassmen()) : ($eqeqeq(/^NJ(\d+)$/i, $ret_or_1) ? (((level = $$('Regexp').$last_match(1).$to_i()), self.$getUsuallyEncount(level))) : ($eqeqeq(/^BS(\d+)$/i, $ret_or_1) ? (((level = $$('Regexp').$last_match(1).$to_i()), self.$getBossEncount(level))) : ("")))))))))))))))))))))));
          return result;
        });
        
        $def(self, '$check', function $$check(base, modify) {
          var self = this, dice1 = nil, dice2 = nil, diceTotal = nil, addTotal = nil, total = nil, result = nil;
          ...
          result['$text=']("EL");
          if (!$truthy(base['$zero?']())) {
            result['$text=']($rb_plus(result.$text(), base.$to_s()))
          };
          if (!$truthy(modify['$zero?']())) {
            result['$text=']($rb_plus(result.$text(), self.$getValueString(modify)))
          };
          result['$text=']($rb_plus(result.$text(), " ＞ "));
          result['$text=']($rb_plus(result.$text(), "(2D6" + (self.$getValueString(base)) + (self.$getValueString(modify)) + ")"));
          result['$text=']($rb_plus(result.$text(), " ＞ " + (diceTotal) + "[" + (dice1) + "," + (dice2) + "]" + (self.$getValueString(addTotal)) + " ＞ " + (total)));
          if ($eqeq(dice1, dice2)) {
            
            self.$getSpecialResult(dice1, total, result);
            return result;
          };
          result = self.$getCheckResult(total, result);
          return result;
        });
        
        $def(self, '$getValue', function $$getValue(string) {
        ...
        $def(self, '$getValueString', function $$getValueString(value) {
        ...
        $def(self, '$getCheckResult', function $$getCheckResult(total, result) {
          ...
          return self.$getSuccessResult(success, result);
        });
        
        $def(self, '$getSuccessResult', function $$getSuccessResult(success, result) {
          
          
          result['$success='](true);
          result['$text=']($rb_plus(result.$text(), " ＞ 成功度" + (success)));
          if ($truthy($rb_ge(success, $$('SUCCESS_MAX')))) {
            
            result['$critical='](true);
            result['$text=']($rb_plus(result.$text(), " ＞ 大成功 《アウル》2点獲得"));
          };
          return result;
        });
        $const_set($nesting[0], 'SUCCESS_MAX', 5);
        
        $def(self, '$getSuccessRank', function $$getSuccessRank(total) {
          var success = nil;
          ...
          if ($truthy($rb_gt(success, $$('SUCCESS_MAX')))) {
            success = $$('SUCCESS_MAX')
          };
          return success;
        });
        
        $def(self, '$getSpecialResult', function $$getSpecialResult(number, total, result) {
          var self = this;

          
          self.$debug("getSpecialResult", number);
          if ($eqeq(number, 6)) {
            return self.$getCriticalResult(result)
          };
          return self.$getFambleResultText(number, total, result);
        });
        
        $def(self, '$getCriticalResult', function $$getCriticalResult(result) {
          var self = this;

          return self.$getSuccessResult($$('SUCCESS_MAX'), result)
        });
        
        $def(self, '$getFambleResultText', function $$getFambleResultText(number, total, result) {
          var self = this;
          ...
          if ($eqeq(number, 1)) {
            ...
            result['$fumble='](true);
            result['$failure='](true);
            result['$text=']($rb_plus(result.$text(), " ＞ 大失敗"));
            return result;
          };
          result = self.$getCheckResult(total, result);
          result['$text=']($rb_plus(result.$text(), " ／ (" + ($rb_minus(number, 1)) + "回目のアシストなら)大失敗"));
          self.$debug("getFambleResultText result", result);
          return result;
        });
        
        $def(self, '$getDateBothResult', function $$getDateBothResult(type, pc1, pc2) {
          var self = this, dice1 = nil, dice2 = nil, result = nil, number = nil, tmp = nil;
        ...
        $def(self, '$getDateResult', function $$getDateResult(type, number, pc1, pc2) {
          var $a, $b, self = this, name = nil, table = nil, text = nil;

          
          $b = self.$getDateTableByType(type), $a = $to_ary($b), (name = ($a[0] == null ? nil : $a[0])), (table = ($a[1] == null ? nil : $a[1])), $b;
        ...
        $def(self, '$getDateTableByType', function $$getDateTableByType(type) {
          var self = this, $ret_or_1 = nil;

          
          if ($eqeqeq(nil, ($ret_or_1 = type))) {
            return self.$getDateTable()
          } else if ($eqeqeq(/^F$/i, $ret_or_1)) {
            return self.$getFrindDateTable()
          } else if ($eqeqeq(/^O$/i, $ret_or_1)) {
            return self.$getOnewayDateTable()
          } else if ($eqeqeq(/^M$/i, $ret_or_1)) {
            return self.$getMidnightDateTable()
          } else {
            nil
          };
          return ["", []];
        ...
        $def(self, '$getDateTable', function $$getDateTable() {
          var name = nil, table = nil;
        ...
        $def(self, '$getFrindDateTable', function $$getFrindDateTable() {
          var name = nil, table = nil;
        ...
        $def(self, '$getOnewayDateTable', function $$getOnewayDateTable() {
          var name = nil, table = nil;
        ...
        $def(self, '$getMidnightDateTable', function $$getMidnightDateTable() {
          var name = nil, table = nil;
        ...
        $def(self, '$changePcName', function $$changePcName(text, base, name) {
          
          
          if (($truthy(name['$nil?']()) || ($truthy(name['$empty?']())))) {
            return text
          };
          return $send(text, 'gsub', [$regexp(["(", base, ")"])], function $$1(){
            return $rb_plus($$('Regexp').$last_match(1), "(" + (name) + ")")});
        });
        
        $def(self, '$getDateValue', function $$getDateValue() {
          var self = this, dice1 = nil;
        ...
        $def(self, '$getClassRoomBreakTable', function $$getClassRoomBreakTable() {
        ...
        $def(self, '$getSchoolStoreBrakeTable', function $$getSchoolStoreBrakeTable() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getClubRoomBrakeTable', function $$getClubRoomBrakeTable() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getStudentCouncilBrakeTable', function $$getStudentCouncilBrakeTable() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getDormitoryBrakeTable', function $$getDormitoryBrakeTable() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getLibraryBrakeTable', function $$getLibraryBrakeTable() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getRoofBrakeTable', function $$getRoofBrakeTable() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getLaboratoryBrakeTable', function $$getLaboratoryBrakeTable() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getPoolBrakeTable', function $$getPoolBrakeTable() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getInnerCourtBrakeTable', function $$getInnerCourtBrakeTable() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getShoppingAvenueBrakeTable', function $$getShoppingAvenueBrakeTable() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getDevastationBrakeTable', function $$getDevastationBrakeTable() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getGateBrakeTable', function $$getGateBrakeTable() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getBreakTable', function $$getBreakTable(name, table) {
          var self = this, number = nil, index = nil, text = nil;

          
          number = self.randomizer.$roll_sum(2, 6);
        ...
        $def(self, '$getD6Table', function $$getD6Table(name, table) {
          var self = this, number = nil, index = nil, text = nil;
        ...
        $def(self, '$getBattleFieldTable', function $$getBattleFieldTable() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getFatalWoundsTable', function $$getFatalWoundsTable() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getFumbleTable', function $$getFumbleTable() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getRandomNpcSchoolLife', function $$getRandomNpcSchoolLife() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getRandomNpcOther', function $$getRandomNpcOther() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getRandomNpcDownClassmen', function $$getRandomNpcDownClassmen() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getRandomNpcUpperClassmen', function $$getRandomNpcUpperClassmen() {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getRandomNpc', function $$getRandomNpc(name, table) {
          var $a, $b, self = this, result = nil, number = nil;

          
          $b = self.$get_table_by_d66_swap(table), $a = $to_ary($b), (result = ($a[0] == null ? nil : $a[0])), (number = ($a[1] == null ? nil : $a[1])), $b;
          return "" + (name) + "(" + (number) + ") " + (result);
        });
        
        $def(self, '$getUsuallyEncount', function $$getUsuallyEncount(level) {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getBossEncount', function $$getBossEncount(level) {
          var self = this, name = nil, table = nil;
        ...
        $def(self, '$getEncountTableResult', function $$getEncountTableResult(name, table, level) {
          var self = this, dice = nil, index = nil, text = nil;
