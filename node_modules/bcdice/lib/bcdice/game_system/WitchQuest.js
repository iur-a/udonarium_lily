...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $eqeqeq = Opal.eqeqeq, $def = Opal.def, $send = Opal.send, $eqeq = Opal.eqeq, $rb_plus = Opal.rb_plus, $truthy = Opal.truthy, $rb_ge = Opal.rb_ge, $to_ary = Opal.to_ary, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $const_set($nesting[0], 'ID', "WitchQuest");
        $const_set($nesting[0], 'NAME', "ウィッチクエスト");
        $const_set($nesting[0], 'SORT_KEY', "ういつちくえすと");
        $const_set($nesting[0], 'HELP_MESSAGE', "・チャレンジ(成功判定)(WQn)\n" + "　n回2d6ダイスを振って判定を行います。\n" + "　例）WQ3\n" + "・SET（ストラクチャーカードの遭遇表(SETn)\n" + "　ストラクチャーカードの番号(n)の遭遇表結果を得ます。\n" + "　例）SET1　SET48\n");
        self.$register_prefix("WQ", "SET");
        
        $def(self, '$eval_game_system_specific_command', function $$eval_game_system_specific_command(command) {
          var self = this, $ret_or_1 = nil, number = nil;

          
          if ($eqeqeq(/WQ(\d+)/, ($ret_or_1 = command))) {
            
            number = $$('Regexp').$last_match(1).$to_i();
            return self.$challenge(number);
          } else if ($eqeqeq(/SET(\d+)/, $ret_or_1)) {
        ...
        $def(self, '$challenge', function $$challenge(number) {
          var self = this, success = nil, results = nil, successText = nil;

          
          success = 0;
          results = [];
          $send(number, 'times', [], function $$1(){var self = $$1.$$s == null ? this : $$1.$$s, value1 = nil, value2 = nil;
            if (self.randomizer == null) self.randomizer = nil;

            
            value1 = self.randomizer.$roll_once(6);
            value2 = self.randomizer.$roll_once(6);
            if ($eqeq(value1, value2)) {
              success = $rb_plus(success, 1)
            };
            return results['$<<']("" + (value1) + "," + (value2));}, {$$s: self});
          successText = $rb_plus("(" + (results.$join(" / ")) + ") ＞ ", self.$getSuccessText(success));
          return successText;
        });
        
        $def(self, '$getSuccessText', function $$getSuccessText(success) {
        ...
        $def(self, '$getStructureEncounter', function $$getStructureEncounter(number) {
          ...
          $b = self.$get_table_by_1d6(table), $a = $to_ary($b), (text = ($a[0] == null ? nil : $a[0])), (index = ($a[1] == null ? nil : $a[1])), $b;
          person = self.$getPersonTable1();
          return "SET" + (number) + " ＞ " + (index) + ":" + (text) + (person);
        });
        
        $def(self, '$getPersonTable1', function $$getPersonTable1() {
          var self = this, gotoNextTable = nil, table = nil;

          
          gotoNextTable = $send(self, 'lambda', [], function $$2(){var self = $$2.$$s == null ? this : $$2.$$s;

            return $rb_plus("表２へ", self.$getPersonTable2())}, {$$s: self});
        ...
        $def(self, '$getPersonTable2', function $$getPersonTable2() {
          var self = this, gotoNextTable = nil, table = nil;

          
          gotoNextTable = $send(self, 'lambda', [], function $$3(){var self = $$3.$$s == null ? this : $$3.$$s;

            return $rb_plus("表３へ", self.$getPersonTable3())}, {$$s: self});
        ...
        $def(self, '$getPersonTable3', function $$getPersonTable3() {
          var self = this, gotoNextTable = nil, table = nil;

          
          gotoNextTable = $send(self, 'lambda', [], function $$4(){var self = $$4.$$s == null ? this : $$4.$$s;

            return $rb_plus("表４へ", self.$getPersonTable4())}, {$$s: self});
        ...
        $def(self, '$getPersonTable4', function $$getPersonTable4() {
          var self = this, table = nil;
        ...
        return $def(self, '$getPersonTable', function $$getPersonTable(table) {
