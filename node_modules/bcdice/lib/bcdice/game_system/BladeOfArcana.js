...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $send2 = Opal.send2, $find_super = Opal.find_super, $def = Opal.def, $eqeqeq = Opal.eqeqeq, $eqeq = Opal.eqeq, $not = Opal.not, $neqeq = Opal.neqeq, $truthy = Opal.truthy, $rb_lt = Opal.rb_lt, $rb_le = Opal.rb_le, $rb_gt = Opal.rb_gt, $rb_minus = Opal.rb_minus, $send = Opal.send, $rb_plus = Opal.rb_plus, $rb_ge = Opal.rb_ge, $nesting = [], nil = Opal.nil;
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $def(self, '$eval_game_system_specific_command', function $$eval_game_system_specific_command(command) {
          var self = this, $ret_or_1 = nil, counts = nil, judgment = nil, option1 = nil, argument1 = nil, option2 = nil, argument2 = nil, critical = nil, fumble = nil, sign = nil, title = nil, table = nil;

          
          if ($eqeqeq(/^(\d+)A(\d*)([CF]?)(\d*)([CF]?)(\d*)$/, ($ret_or_1 = command.$upcase()))) {
            ...
            if ((($neqeq(option1['$empty?'](), argument1['$empty?']()) || ($neqeq(option2['$empty?'](), argument2['$empty?']()))) || (($not(option2['$empty?']()) && ($eqeq(option1, option2)))))) {
              return nil
            };
            if ($eqeq(option1, "C")) {
        ...
        $def(self, '$rollAct', function $$rollAct(counts, judgment, critical, fumble) {
          var self = this, dice_list = nil, value = nil, string = nil, text = nil;

          
          if (judgment == null) judgment = 0;
          if (critical == null) critical = 0;
          if (fumble == null) fumble = 0;
        ...
        return $def(self, '$tableText', function $$tableText(title, table, sign) {
