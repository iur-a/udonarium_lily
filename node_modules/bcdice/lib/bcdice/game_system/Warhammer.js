...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.4 */
  var $module = Opal.module, $klass = Opal.klass, $const_set = Opal.const_set, $send2 = Opal.send2, $find_super = Opal.find_super, $def = Opal.def, $eqeqeq = Opal.eqeqeq, $eqeq = Opal.eqeq, $truthy = Opal.truthy, $rb_le = Opal.rb_le, $rb_divide = Opal.rb_divide, $rb_minus = Opal.rb_minus, $rb_gt = Opal.rb_gt, $rb_lt = Opal.rb_lt, $rb_times = Opal.rb_times, $rb_plus = Opal.rb_plus, $rb_ge = Opal.rb_ge, $neqeq = Opal.neqeq, $send = Opal.send, $thrower = Opal.thrower, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
    ...
    return (function($base, $parent_nesting) {
      ...
      return (function($base, $super, $parent_nesting) {
        ...
        $def(self, '$eval_game_system_specific_command', function $$eval_game_system_specific_command(command) {
          var self = this, output_msg = nil, $ret_or_1 = nil, attackCommand = nil, criticalCommand = nil;

          
          output_msg = nil;
          if ($eqeqeq(/^(WH\d+(@[\dWH]*)?)/i, ($ret_or_1 = command.$upcase()))) {
            
            attackCommand = $$('Regexp').$last_match(1);
            output_msg = self.$getAttackResult(attackCommand);
          } else if ($eqeqeq(/^(WH[HABTLW]\d+)/i, $ret_or_1)) {
        ...
        $def(self, '$result_1d100', function $$result_1d100(total, _dice_total, cmp_op, target) {
          ...
          if ($truthy($rb_le(total, target))) {
            return $$('Result').$success("成功(成功度" + ($rb_divide($rb_minus(target, total), 10).$to_i()) + ")")
          } else {
            return $$('Result').$failure("失敗(失敗度" + ($rb_divide($rb_minus(total, target), 10).$to_i()) + ")")
          };
        });
        
        $def(self, '$result_1d100_text', function $$result_1d100_text(total, dice_total, cmp_op, target) {
          var $a, self = this, result = nil;

          
          result = ($a = self.$result_1d100(total, dice_total, cmp_op, target), ($a === nil || $a == null) ? nil : $a.$text());
        ...
        $def(self, '$getCriticalResult', function $$getCriticalResult(string) {
          var self = this, whh = nil, wha = nil, whb = nil, whl = nil, whw = nil, criticalTable = nil, partsWord = nil, criticalValue = nil, whpp = nil, whppp = nil, $ret_or_1 = nil, dice_now = nil, crit_no = nil, crit_num = nil, resultText = nil, output = nil;
          ...
          criticalTable = Opal.large_array_unpack("5,7,9,10,10,10,10,10,10,10,5,6,8,9,10,10,10,10,10,10,4,6,8,9,9,10,10,10,10,10,4,5,7,8,9,9,10,10,10,10,3,5,7,8,8,9,9,10,10,10,3,4,6,7,8,8,9,9,10,10,2,4,6,7,7,8,8,9,9,10,2,3,5,6,7,7,8,8,9,9,1,3,5,6,6,7,7,8,8,9,1,2,4,5,6,6,7,7,8,8");
          if (!$truthy(/WH([HABTLW])(\d+)/['$=~'](string))) {
            return "1"
          };
          partsWord = $$('Regexp').$last_match(1);
          criticalValue = $$('Regexp').$last_match(2).$to_i();
          ...
          whpp = "";
          whppp = "";
          if ($eqeqeq(/H/i, ($ret_or_1 = partsWord))) {
            ...
            whpp = "腕部";
            whppp = wha;
          } else if ($eqeqeq(/[TB]/i, $ret_or_1)) {
            
            whpp = "胴体";
            whppp = whb;
          } else if ($eqeqeq(/L/i, $ret_or_1)) {
            
            whpp = "脚部";
            whppp = whl;
          } else if ($eqeqeq(/W/i, $ret_or_1)) {
        ...
        $def(self, '$wh_atpos', function $$wh_atpos(pos_num, pos_type) {
          var self = this, pos_2l = nil, pos_2lw = nil, pos_4l = nil, pos_4la = nil, pos_4lw = nil, pos_b = nil, wh_pos = nil, pos_t = nil, $ret_or_1 = nil, output = nil, pos_i = nil;
          ...
          if ($neqeq(pos_type, "")) {
            if ($eqeqeq(/@(2W|W2)/i, ($ret_or_1 = pos_type))) {
              pos_t = 1
            } else if ($eqeqeq(/@(4W|W4)/i, $ret_or_1)) {
              pos_t = 4
            } else if ($eqeqeq(/@(4H|H4)/i, $ret_or_1)) {
              pos_t = 3
            } else if ($eqeqeq(/@4/i, $ret_or_1)) {
              pos_t = 2
            } else if ($eqeqeq(/@W/i, $ret_or_1)) {
              pos_t = 5
          ...
          if ($truthy($rb_lt(pos_t, 0))) {
            $send(wh_pos, 'each', [], function $$1(pos_i){var self = $$1.$$s == null ? this : $$1.$$s;

              
              if (pos_i == null) pos_i = nil;
              return (output = $rb_plus(output, self.$get_wh_atpos_message(pos_i, pos_num)));}, {$$s: self})
          } else {
        ...
        $def(self, '$get_wh_atpos_message', function $$get_wh_atpos_message(pos_i, pos_num) {
          var output = nil;

          
          output = "";
          output = $rb_plus(output, $rb_plus($rb_plus(" ", pos_i['$[]'](0)), ":"));
          (function(){try { var $t_break = $thrower('break'); return $send((1), 'step', [$rb_plus(pos_i.$length(), 1), 2], function $$2(i){
        ...
        return $def(self, '$getAttackResult', function $$getAttackResult(string) {
